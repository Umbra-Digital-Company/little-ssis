    ...
    <a href="./?page=<?= $_GET['bpage']?>" class="exit-frame-selection">
           ...
           <form action="#" method="post">
            ...
            <div class=" d-flex justify-content-center mt-4" >
                    ...
                    <div class="col-xs-12">
                        <a href="/v2.0/sis/studios/func/process/order_payment.php?path_loc=ph"><input type="button" class="btn btn-primary" value="Dispatch"></a>
                    </div>
                </div>
            </form>
    </section>
        ...
        $(this).on('click', '.add_count_increment', function(){
            ...
            if(count_num_val >= total_count){
                if(confirm('Your about to exceed the total count of frames.')){
                    ...
                    $.post("/v2.0/sis/studios/func/process/add_to_bag_merch.php",{studios_product_code: _this.attr('product-code')}, function(result){
                        //console.log(result);
