...
<?php if(isset($_SESSION['user_type']) && $_SESSION['user_type'] == '1'){ ?>
		...
		<div class="wrapper">
	        <p class="text-center font-bold h2 pt-3 pb-3">Proceed to step 2</p>
	        <div class="text-center mt-4">
	            <a href="/v2.0/sis/studios/func/process/guest_register.php?path_loc=ph"><button class="btn btn-primary">Proceed</button></a>
	        </div>    
	    </div>
<?php }else{ ?>
	<?php if ( !isset($_SESSION['customer_id']) ) : ?>
		<div class="switch-layout">
			...
			<div class="account-navigation d-flex no-gutters">
					<a href="#create-content" class="col-6 text-center account-option <?= ( !isset($_SESSION['customer_id']) && !isset($_SESSION['temp_data']) ) ? 'active' : '' ?>">Register</a>
		...
		<form method="post" id="use_account" name="use_account" autocomplete="off" class="mt-0">
			<div class="d-flex form-group justify-content-center">
				...
				<div class="form-group col-md-6 col-sm-5" id="div_mobile_number" >
					...
					<label class="placeholder" for="username" style="margin-left:15px;">Email or Mobile Number</label>
	...
	<div class="account-content active mt-4 mb-4" id="create-content">
		<form name="create_account" id="create_account" action="/v2.0/sis/studios/func/process/store-register.php" method="POST" autocomplete="off">
			<input type="hidden" value="ph" name="path_loc">
			<input type="hidden" value="<?php echo $password; ?>" name="password2">
			<input type="hidden" value="<?php echo $password; ?>" name="confirmPassword2">
			<input type="hidden" name="specs_branch" value="<?= 'This Store Name' ?>">
			<input type="hidden" name="joining_date" value="<?= date('Y/m/d'); ?>">

			<p class="font-bold text-uppercase text-primary">personal details</p>
			<div class="form-row no-gutters mt-3">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<label class="placeholder" for="fname">First Name</label>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						<input type="text" name="mname" class="form-control" id="mname" value="<?= get_customer_data('middle_name') ?>" required>
						<label class="placeholder" for="mname">Middle Name</label>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
					<input type="text" name="bdate" class="form-control" id="bdate" value="<?= get_customer_data('birthday') ?>" required>
						...
						<label class="placeholder" for="bdate2">Birthdate</label>
					...
					<div class="form-group gender">
						<div class="d-flex no-gutters">
							<div class="col">
								...
								<label class="form-control col" for="gender-male">Male</label>
							</div>
							<div class="col">
								...
								<label class="form-control col" for="gender-female">Female</label>
							</div>
						</div>
					</div>
				</div>
			...
			<p class="font-bold text-uppercase text-primary mt-2">present address</p>
			<div class="form-row no-gutters mt-3">
				<div class="col-12">
					<div class="form-group">
						<input type="text" name="home_address" class="form-control" id="home_address" value="<?= get_customer_data('address') ?>" required>
						<label class="placeholder" for="home_address">Home Address</label>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<label class="placeholder" for="country">Country</label>
					</div>
				</div>
				<div class="col-6" <?= ($_SESSION['user_type'] == 3) ? 'style="display:none;"' : '' ?> >
					<div class="form-group">
			...
			<p class="font-bold text-uppercase text-primary mt-2">contact details</p>
			<div class="form-row no-gutters mt-3">
				<div class="col-6">
					<div class="form-group">
						<?php if ( isset($_SESSION['customer_id']) ) : ?>
						...
						<label class="placeholder" for="s_email">Email Address</label>
