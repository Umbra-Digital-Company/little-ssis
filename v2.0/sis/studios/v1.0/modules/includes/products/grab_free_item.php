...
$querypn .=' FROM 
            ...
            WHERE
                p.data_cgc IN("DCGC0044","DCGC0046","DCGC0047","DCGC0052")
    ...
    $queryAll = 'SELECT 
                    ...
                    FROM poll_51_studios_new ps
                        INNER JOIN products_colors_studios pcs ON ps.product_code = pcs.product_code 
                            WHERE ps.data_cgc IN("DCGC0044","DCGC0046","DCGC0047","DCGC0052")
...
include "./modules/includes/products/function_cart.php";
