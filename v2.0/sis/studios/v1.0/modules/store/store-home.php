...
if (!isset($_SESSION["store_code"]) && $_SESSION["store_code"] == '') {
	...
	echo '<script>	window.location.href="/v2.0/sis/studios/v1.0"; </script>';
} else { ?>
	...
	*/
	...
	<link rel="stylesheet" type="text/css" href="/v2.0/sis/studios/v1.0/modules/store/little_sis.css?v=12345">
	<style type="text/css">
