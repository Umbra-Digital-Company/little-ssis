<?php if (!isset($_SESSION['customer_id'])) { ?>
    ...
    <div class="wrapper">
        ...
        <div class="text-center mt-4">
            <a href="/v2.0/sis/studios/v1.0/?page=store-home"><button
    ...
    <div id="select_frame">
                ...
                <a href="./?page=select-store-studios">
                    <div class="col-12 text-start ">
                        ...
                        <img class="img-fluid img-header"
                            src="/v2.0/sis/studios/assets/images/sections/sun-frames.webp?v=1614047286">
        ...
        <div class="form-row mb-4 section-antirad">
            ...
            <a href="./?page=select-antirad">
                <div class="col-12 text-center ">
                    <img class="img-fluid img-header"
                        src="/v2.0/sis/studios/assets/images/sections/anti-rad-frames.webp?v=1614047286">
        ...
        <div class="form-row mb-4 section-readers">
            ...
            <a href="./?page=select-readers">
                <div class="col-12 text-center ">
                    <img class="img-fluid img-header" src="/v2.0/sis/studios/assets/images/sections/readers.png?v=1614047286">
        ...
        <div class="form-row mb-4 section-free-item">
            ...
            <a href="./?page=select-free-item">
                <div class="col-12 text-center ">
                    <img class="img-fluid img-header" src="/v2.0/sis/studios/assets/images/sections/merch.webp?v=1614047286">
