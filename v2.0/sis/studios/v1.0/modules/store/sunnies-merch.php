...
?>
    ...
    <div class="packages-list hiding">
        <?php if (isset($_GET['product-detail']) && trim($_GET['product-detail']) != "") {
            ...
            $arrProductDetails = array_values(array_filter($arrMerchSorted, function ($item) {
        ...
        ?>
            ...
            <section class="product-view" id="product-panel" style="height:100vh; max-width: 575px; overflow: auto;">
                ...
                <script>
                    ...
                    console.log("data", <?= json_encode($arrMerchSorted) ?>);
                </script>
                ...
                <form href="#" id="form-add-to-bag">
                    ...
                    <div class="frame-style card  mb-3 hide-lazy" data-style="<?= $arrProductDetails[0]['item_description'] ?>">
                        ...
                        <div class="frame-style__slider">
                            ...
                            $curColors = $arrProductDetails[0]['colors'];
                        ...
                        <div style="background: #fff; border-radius: 0 0 10px 10px; padding: 15px;">
                            ...
                            <div class="d-flex justify-content-between">
                                <section
                                    ...
                                    <div>
                                        ...
                                        <h4><span class="blk"><?= $curColors[0]['color'] ?></span> </h4>
                                    </div>
                                </section>
                            ...
                            <ul class="row switch-color col-12">
                                ...
                                foreach ($curColors as $key => $value) {
                                    $a = $key;
                                ?>
                                    <li class="<?= $a === 0 ? 'active' : '' ?> visible color-swatch " data-index="<?= $a ?>"
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <div class="description">
                                    <?php
                                    $product_description = ($arrProductDetails[0]['product_description'] != null && $arrProductDetails[0]['main_description'] != '')
            ...
            <section class="product-panel" id="product-panel">
                ...
                <div id="btn-filter" class="btn btn-not-cancel" 
                    ...
                    <?php if (isset($_GET['filter']) && $_GET['filter']) { ?>   
                        <a href="/v2.0/sis/studios/v1.0/?page=<?= $_GET['page'] ?>" 
                        onclick=""> 
                    ...
                    <div class="row align-items-start align-items-stretch product-show" style="margin: 0 -10px;">
                        ...
                        <?php for ($i = 0; $i < $showDataCount; $i++) { ?>
                            <div class="frame-style col-6 mb-3 hide-lazy"
                                data-style="<?= $arrMerchSorted[$i]['item_description'] ?> ">
                                ...
                                <div style="background: #fff; border-radius: 0 0 10px 10px; padding: 15px;">
                                    ...
                                    <ul class="row switch-color col-12">
                                        ...
                                        if ($totalColors > $maxVisibleColors) {
                                            ...
                                            ?>
                                                <li class="hidden hidden-colors" id="<?= trim($arrMerchSorted[$i]['item_description']) ?>"
                                                    data-index="<?= $a ?>"
                                                    data-style-name="<?= trim(str_replace(" ", "-", strtolower($arrProductsSorted[$i]['item_description']))) ?>"
                                                    data-color-name="<?= trim($curColors[$a]['color']) ?>"
                                                    data-color-code="<?= trim($curColors[$a]['product_code']) ?>"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#cart").click(function() {
                window.location.href = "/v2.0/sis/studios/v1.0/?page=cart";
                // let item_cart = '';
            ...
            $(this).on('click', '.remove_item', function() {
                let this_div = $(this);
                let remove = $.post("/v2.0/sis/studios/func/process/remove_item.php", {
            ...
            $('#search_frame').on('keyup', function(e) {
                if (e.keyCode === 13) { // Check if Enter key is pressed
                    ...
                    window.location = '?page=select-merch' + filter + '&search=' + $(this).val();
                }
            });
