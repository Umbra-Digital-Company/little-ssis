...
?>
	...
	<div class="account-content" id="use-content">
			...
			<div class="text-center mt-5">
				<div class="form-row">
					<div class="col-md-12 form-group">
						<input type="button" name="btnsubmit" id="btnsubmit" value="Continue" class="btn btn-custom-blue" style="background-color: #0b5893 !important;"/>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#btn-signup').click(function(){
					$('#mobile-format_login').css('display','none', 'important');
				});
			})
		...
		<form name="update_guest_account" id="update_guest_account" method="POST" autocomplete="off">
			...
			<div class="form-row no-gutters mt-3">
				...
				<div class="form-group col-md-12 col-sm-12 mt-2" id="div_birthdate" data-provide="datepicker">
						<input name="bdate" class="form-control" id="bdate" required="required" type="text" value="" />
						<label class="placeholder" for="bdate"><?= $arrTranslate['Birthdate'] ?></label>
				...
				$('#bdate').on('keydown keypress keyup', function (event) {
...
<!-- -->
			...
			<div class="form-row no-gutters mt-3">
				...
				<div class="col-md-12 col-sm-12 d-flex align-items-center">
					<div class="d-flex form-group col-sm-3" style='padding-left: 0px; padding-right: 0px;'>
						<select class="text-left select form-control" name="country_codes" id="country_codes" style="margin: 0px; padding-top:0px; padding-bottom:0px; border-bottom-right-radius: 0px; border-top-right-radius: 0px;" required>
					...
					<div class="form-group col-sm-9 country_num" style='padding-left: 0px; padding-right: 0px;'>
					<input type="text"
								style="border-bottom-left-radius: 0px; border-top-left-radius: 0px;"
								name="mnum"
								class="form-control"
								id="mnum" class="mnum" required>
						<!-- <input type="text" style="border-bottom-left-radius: 0px; border-top-left-radius: 0px; border-left-style: none;" name="mnum" class="form-control " id="mnum" class="mnum" required> -->
						<label class="placeholder" for="mnum"><?= $arrTranslate['Mobile Number'] ?></label>
						<!-- <span class="mobile-format" style="display: none;"></span> -->
					</div>
				</div>
			</div>
		...
		$(document).ready(function(){
			...
			<div class="text-center mt-4">
				...
				<button type="submit" class="btn btn-custom-blue" id="submitCustomer">Submit</button>
