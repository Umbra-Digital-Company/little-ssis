        ...
        <?php } else { ?>
            ...
            <section class="product-panel" id="product-panel">
                ...
                <div class="flex-container mb-4 mt-4">
                    <!-- <a href="/v2.0/sis/studios/v1.0/?page=cart" type="button" class="btn btn-bag d-flex" id="cart" title="Cart">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#cart").click(function() {
                ...
                //     if (parseFloat(arrCart[i].price) > 0) {} else if (arrCart[i].item_description.toLowerCase().indexOf('paper a') > -1 || arrCart[i].item_description.toLowerCase().indexOf('sac') > -1 || arrCart[i].item_description.toLowerCase().indexOf('receipt') > -1) {
                //         continue;
                //     }
