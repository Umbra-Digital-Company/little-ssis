                                ...
                                <div style="margin-top: 30px; max-width: 500px;">
                                    ...
                                    <?php 
                                        ...
                                        for ($i=0; $i < sizeOf($arrTags); $i++) { 
                                            ...
                                            echo '<li class="col-4">'.( ucwords(str_replace("desc::", "", $arrTags[$i])) ).'</li>';
        ...
        <section class="col-lg-12 col-md-12 col-xs-12 hidden-xs product-panel" id="product-panel">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div  class="d-flex justify-content-between" id="cart" title="Cart" style="padding-left: 20px;">
                        <img src="/v2.0/sis/studios/assets/images/icons/icon-cart.png" class="img-responsive" width="40px" height="40px">
                                            ...
                                            <div class="col-lg-4 col-xs-12 form-group product-option" product-code="<?= $arrProduct[$i]['product_code'] ?>">
                                                ...
                                                <label class="list-item frame-grid d-flex flex-column align-items-center justify-content-center" style="background-color: #e8e8e4;">
                                                    ...
                                                    <?php
                                                        ...
                                                        $curStyle = $arrFrames[$b]['item_description'];
                                                    ...
                                                    <img src="<?= $curImageURL ?>" class="img-fluid" style="height: auto; width: 100%; max-width: 300px;">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".product-option").click(function(){
            ...
            window.location  ="?page=select-store-studios&product-detail=true&product-code="+tempProduct.product_code+"&desc="+tempProduct.description+"&style="+tempProduct.item_description+"&color="+tempProduct.color+"&price="+tempProduct.price+"&image="+tempProduct.image_url+"&descr="+tempProduct.main_description+"&tags="+tempProduct.tags;
        });
                    ...
                    +'<div class="card-body">'
                        +'<div class="d-flex justify-content-between">'
                            +'<div class="d-flex justify-content-between" style="text-align:left">'
                                +'<div style="text-align:left;">'
                                    +'<img src="'+curImageURL+'" class="img-responsive" width="180" height="120" >'
                                +'</div>'
                            +'</div>'
                            +'<div class="d-flex justify-content-start count_item">'
                                +'<div class="d-flex justify-content-start mt-2">'
                        ...
                        +'</div>'
                        +'<div class="d-flex justify-content-between">'
                            +'<p style="font-size: 12px;  margin-left: 23px;" class="mt-2">'+arrCart[i].item_description+'</p>'
                            +'<p>(<strong>₱</strong>'+parseFloat(arrCart[i].price).toFixed(2)+' x <span class="count_times">'+arrCart[i].count+'</span>)</p>'
                        +'</div>'
                        +'<div class="d-flex justify-content-end">'
                            +'<p><strong>Total: ₱</strong><span class="t_price">'+total_price.toFixed(2)+'</span></p>'
                            +'<img src="/v2.0/sis/studios/assets/images/icons/icon-delete.png" class="img-responsive remove_item" orders-specs-id="'+arrCart[i].group_orders_specs_id+'" style="cursor: pointer; margin-left: 10px;" width="25" height="25" title="Remove this item">'
                        +'</div>'
                    +'</div>'
                +'</div>';
            }
       ...
       $(this).on('click', '.remove_item', function(){
        ...
        $(this).on('click', '.count_increment', function(){
            ...
            merch = (typeof attr !== typeof undefined && attr !== false) ? '_merch' : '';
            $.post("/v2.0/sis/studios/func/process/add_to_bag"+merch+".php",{studios_product_code: _this.attr('product-code')}, function(result){
                //console.log(result);
