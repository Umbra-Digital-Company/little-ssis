                                        ...
                                        ?> 
                                            <div class="col-lg-4 col-xs-12 form-group product-option" product-code="<?= $arrProduct[$i]['product_code'] ?>">
                                                ...
                                                <label class="list-item frame-grid d-flex flex-column align-items-center justify-content-center">
                                                    ...
                                                    <img src="<?= $curImageURL ?>" class="img-fluid" >
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".product-option").click(function(){
            ...
            window.location  ="?page=select-merch&product-detail=true&product-code="+tempProduct.product_code+"&desc="+tempProduct.description+"&style="+tempProduct.item_description+"&color="+tempProduct.color+"&price="+tempProduct.price;
        });
