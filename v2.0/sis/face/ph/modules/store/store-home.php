...
if (!isset($_SESSION["store_code"]) && $_SESSION["store_code"] == '' ) {
	...
	echo '<script>	window.location.href="/v2.0/sis/studios/ph"; </script>';	
} else { ?>
	...
	*/
	...
	<p class="text-center h3"><?= greetings() ?></p>
	...
	<div class="mt-4 custom-card">
		<p class="h2 font-bold text-center">Data and Statistics coming soon</p>
	</div>

	<div class="customer-account text-center mt-5">
		<a href="./?page=health-declaration-form"><button class="btn btn-primary">go to customer page</button></a>
	</div>

	<!-- <div class="customer-account text-center mt-5">
		<a href="./?page=health-declaration-form"><button class="btn btn-link" style="color:#000;">Continue as Guest</button></a>
	</div> -->
