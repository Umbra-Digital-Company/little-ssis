...
<div id="ssis_sidebar">
	...
	<nav id="ssis_menu" class="mt-4">
		...
		<ul class="nav-list nav flex-column">
			...
			<li>
				<a class="d-flex align-items-center" href="/v2.0/sis/face/func/logout.php?path_loc=v1.0">
	...
	<?php if ( isset($_SESSION['customer_page']) && $_SESSION['customer_page'] == 'YES' && !isset($_SESSION['doctor_progress']) ) : ?>
		...
		<?php if ( $page != 'rate-us' ) : ?>
			<div class="language">
				...
				<div class="lang-opt">
					<a href="/v2.0/sis/face/func/process/switch_language.php?language_setting=us">English</a>
					<a href="/v2.0/sis/face/func/process/switch_language.php?language_setting=vn">Vietnamese</a>
				</div>
			</div>
		<?php endif ?>
	...
	<div id="navigation-tab">
		...
		<?php 
			...
			switch ( $page ) {
				...
				case 'select-store-lips'    : $custom_title = 'Lips'; break;
				case 'select-store-face'    : $custom_title = 'Face'; break;
				case 'select-store-brows'    : $custom_title = 'Brows'; break;
				case 'select-store-eyes'    : $custom_title = 'Eyes'; break;
				case 'select-store-skin'    : $custom_title = 'Skin'; break;
				case 'select-store-cheeks'    : $custom_title = 'Cheeks'; break;
				case 'select-store-nails'    : $custom_title = 'Nails'; break;
				case 'select-store-sets'    : $custom_title = 'Sets'; break;
				case 'select-store-all'    : $custom_title = ucwords($_GET['categoryAll']); break;
				case 'select-merch' 		   : $custom_title = 'Merch'; break;
				case 'select-antirad' 		   : $custom_title = 'Anti-Radiation'; break;
				case 'select-readers' 		   : $custom_title = 'Readers'; break;
