    ...
    <div class="mx-2">
            ...
            <div class="customized-card my-4" style="height: 158px;">
                ...
                <div class="d-flex justify-content-between">
                    <div class=" no-gutters d-flex ">
                        ...
                        ?>
                        <img src="<?= !empty($order['image_url']) ? $order['image_url'] : '/v2.0/sis/studios/assets/images/defaults/no_specs_frame_available_b.png' ?>" class="card-img" alt="Product Image" style="width: 120px; height: 126px; object-fit: <?= $fit ?>; border-radius: 8px">
        ...
        <?php if (count($arrCart) > 0): ?>
            ...
            <a href="/v2.0/sis/face/v1.0/?page=select-store" class="btn-custom-white w-100 mt-3 d-flex align-items-center justify-content-center">
                Add Item
