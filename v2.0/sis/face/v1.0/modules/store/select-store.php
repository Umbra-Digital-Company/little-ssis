        ...
        <div class="packages-list">
                ...
                <a href="./?page=select-store-lips">
                    <div class="col-12 text-center ">
                        ...
                        <img class="img-fluid img-header"
                            src="/v2.0/sis/face/assets/images/sections/sunnies-face.png?v=1614047286">
            ...
            <div class="form-row mb-4 section-face">
                ...
                <a href="./?page=select-store-face">
                    <div class="col-12 text-center">
                        ...
                        <img class="img-fluid img-header "
                            src="/v2.0/sis/face/assets/images/sections/face.webp?v=1614047286">
            ...
            <div class="form-row mb-4 section-brows">
                ...
                <a href="./?page=select-store-brows">
                    <div class="col-12 text-center">
                        <img class="img-fluid  img-header"
                            src="/v2.0/sis/face/assets/images/sections/brows.webp?v=1614047286">
            ...
            <div class="form-row mb-4 section-eyes">
                ...
                <a href="./?page=select-store-eyes">
                    <div class="col-12 text-center ">
                        <img class="img-fluid img-header"
                            src="/v2.0/sis/face/assets/images/sections/eyes.webp?v=1614047286">
                        <div class="select-link">
                            <a href="./?page=select-store-eyes">
            ...
            <div class="form-row mb-4 section-skin">
                ...
                <a href="./?page=select-store-skin">
                    <div class="col-12 text-center">
                        <img class="img-fluid img-header" src="/v2.0/sis/face/assets/images/sections/skin.webp?v=1614047286">
            ...
            <div class="form-row mb-4 section-cheeks">
                ...
                <a href="./?page=select-store-cheeks">
                    <div class="col-12 text-center">
                        <img class="img-fluid img-header" src="/v2.0/sis/face/assets/images/sections/cheeks.jpg?v=1614047286">
            ...
            <div class="form-row mb-4 section-nails">
                ...
                <a href="./?page=select-store-nails">
                    <div class="col-12 text-center ">
                        <img class="img-fluid img-header" src="/v2.0/sis/face/assets/images/sections/nails.jpg?v=1614047286">
            ...
            <div class="form-row mb-4 section-sets">
                ...
                <a href="./?page=select-store-sets">
                    <div class="col-12 text-center ">
                        ...
                        <img class="img-fluid img-header" src="/v2.0/sis/face/assets/images/sections/sets.jpg?v=1614047286">
            ...
            <div class="form-row mb-4 section-merch">
                ...
                <a href="./?page=select-store-merch">
                    <div class="col-12 text-center ">
                        <img class="img-fluid img-header" src="/v2.0/sis/face/assets/images/sections/Travel_Kit_Merch_Category_Banner_-_Desktop.webp?v=1614047286">
