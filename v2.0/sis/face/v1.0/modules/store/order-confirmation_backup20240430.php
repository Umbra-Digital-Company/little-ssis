    ...
    <section class="col-lg-12 col-md-12 col-xs-12 hidden-xs product-panel" id="product-panel">
        ...
        <?php
            ...
            for($i = 0; $i< count($arrCart); $i++) {
                ...
                // }
                //  $curImageURL = (@getimagesize($curImageURL)) ?  $curImageURL : '/v2.0/sis/face/assets/images/defaults/no_specs_frame_available_b.png';
        ...
        <?php } ?>
            ...
            <div class="row d-flex justify-content-center mt-5" >
                ...
                <div class="col-12">
                    ...
                    <a href="/v2.0/sis/face/func/process/order_payment.php?path_loc=v1.0" id="send-order"><input type="button" class="btn btn-black" value="<?= $textSend ?>"></a>
                </div>
            </div>            
        </form>
    </section>
    ...
    $(document).ready(function(){
        $(this).on('click', '.add_count_increment_pbag', function(){
            ...
            if(count_num_val >= total_count){
                if(confirm('Your about to exceed the total count of frames.')){
                    ...
                    $.post("/v2.0/sis/face/func/process/add_to_bag_merch.php",{studios_product_code: productSelected, paper_bag:true}, function(result){
                        //console.log(result);
        ...
        $(this).on('click', '.minus_count_decrement_pbag', function(){
           ...
           if(current_value > 0){
                ...
                $.post("/v2.0/sis/face/func/process/remove_item.php",{orders_specs_id: arrOrdersSpescIdRemove}, function(){
        ...
        $(this).on('click','#add_section_paper_bag',function(){
            $.get('/v2.0/sis/face/v1.0/modules/includes/products/add_paper_bag_section.php', function(result){
        ...
        $(this).on('click','#add_section_sac',function(){
            $.get('/v2.0/sis/face/v1.0/modules/includes/products/add_sac_section.php', function(result){
        ...
        $(this).on('click','.set_receipt_holder',function(){
            ...
            if($(this).val() == 'yes'){
                if($(this).attr('orders-specs-id') == ''){
                    $('#loading').modal('show');
                    $.post("/v2.0/sis/face/func/process/add_to_bag_merch.php",{studios_product_code: $(this).attr('product-code'), paper_bag:true}, function(result){
                ...
                if($(this).attr('orders-specs-id') != ''){
                    $('#loading').modal('show');
                     $.post("/v2.0/sis/face/func/process/remove_item.php",{orders_specs_id: $(this).attr('orders-specs-id')}, function(){
        ...
        $(this).on('click','#add_section_others',function(){
            $.get('/v2.0/sis/face/v1.0/modules/includes/products/add_others_section.php', function(result){
        ...
        $('#btn-signup').click(function(){
         ...
         $('#update_guest_account').submit(function(e){
            e.preventDefault();
            $.ajax({
                url: "/v2.0/sis/face/func/process/signup-guest-account.php",
                type: "post",
                data: $(this).serialize() ,
