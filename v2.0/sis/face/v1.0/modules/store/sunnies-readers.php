...
<?php
   ...
   include "./modules/includes/products/grab_readers.php";
?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(this).on('click','.product-option',function(){
            ...
            window.location  ="?page=select-readers&product-detail=true&product-code="+tempProduct.product_code+"&desc="+tempProduct.description+"&style="+tempProduct.item_description+"&color="+tempProduct.color+"&price="+tempProduct.price+"&image="+tempProduct.image_url+"&descr="+tempProduct.product_description+"&tags="+tempProduct.tags;
        });
        ...
        $(document).on('submit', "#form-add-to-bag", function(e){
            e.preventDefault();
            $.ajax({
                url: "/v2.0/sis/face/func/process/add_to_bag_antirad.php",
                type: "POST",
                data: $(this).serialize(),
                dataType: 'html',
                success: function(response){
                    window.location  ="?page=select-readers";
                },
                error: function(){
                }
            });//END :: AJAX
       ...
       $(this).on('click', '.remove_item', function(){
        ...
        $('#search_frame').on('keyup', function () {
            ...
            setTimeout(()=>{
                window.location = '?page=select-readers'+filter+'&search='+$(this).val(); 
             },3000);
        ...
        $('#filter-search-data').click(function(){
            ...
            window.location = '?page=select-readers'+filter+'&colors='+arrColors+'&shapes='+arrShapes+'&collections='+arrCollections;  
        });
    });
