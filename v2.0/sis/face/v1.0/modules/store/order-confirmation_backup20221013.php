    ...
    <section class="col-lg-12 col-md-12 col-xs-12 hidden-xs product-panel" id="product-panel">
        ...
        <?php
            ...
            for($i = 0; $i< count($arrCart); $i++) {
                ...
                if(strstr(strtolower($arrCart[$i]['item_description']),'paper bag') || strstr(strtolower($arrCart[$i]['item_description']),'sac') || strstr(strtolower($arrCart[$i]['item_description']),'receipt')){
        ...
        <?php } ?>
                ...
                <div id="paperbag-set-list" class="pl-2 pr-2 pt-1" style="">
                    ...
                    <div class="card mt-3 card-others" style="background-color: #E8E8E4 !important">
                        ...
                        ?>
                            <div class="card-body pt-3 pb-1 pl-1">
                                        ...
                                        <div class="product-section d-flex justify-content-between">
                                            <div class="d-flex justify-content-between" style="text-align:left">
                                                <div style="text-align:left;" class="form-group col-12">
                                                    ...
                                                    <label class="placeholder" style="background-color: #e8e8e4;">Others</label>
                                                </div>
                                            </div>
                                ...
                                ?>
                                            <div class="product-section d-flex justify-content-between">
                                                ...
                                                <div style="text-align: right;">
                                                    <div class="d-flex justify-content-start mt-2 count_item">
                                                        <span><input type="button" class="form-control minus_count_decrement_others" group-orders-specs-id="<?= implode(",", $groupSelected) ?>" value="-"></span>
                                                        <input type="text" class="form-control count_num_others" value="<?= $countSelected ?>" readonly>
                                                        <span><input type="button" class="form-control add_count_increment_others" group-orders-specs-id="<?= implode(",", $groupSelected) ?>" value="+"></span>
                                                    </div>
                         ...
                         <div>
                            <input type="button" value="Add Additional Others" id="add_section_others" class="btn btn-primary">
                        </div>
                    </div>
                </div>
            ...
            <div class="row d-flex justify-content-center mt-5" >
                ...
                <div class="col-12">
                    ...
                    <a href="/v2.0/sis/studios/func/process/order_payment.php?path_loc=v1.0"><input type="button" class="btn btn-black" value="<?= $textSend ?>"></a>
                </div>
            </div>            
        </form>
    </section>
