...
$querypn .=' FROM 
                poll_51_face_new p
            WHERE p.data_cgc IN("DCGC0036","DCGC0040","DCGC0042","DCGC0052","DCGC0053", "DCGC0072")
                    '.$priceWhere.'
            ORDER BY 
                p.item_name ASC;';
...
$arrColorData = [];
    $queryAll = 'SELECT DISTINCT
                    ...
                    WHERE 
                        p.data_cgc IN("DCGC0036","DCGC0040","DCGC0042","DCGC0052","DCGC0053", "DCGC0072")
...
if(!isset($_GET['filter'])){
    ...
    $queryAll = "SELECT
                    ...
                    p51.item_code
                     ...
                     WHERE ss.category = 'face' AND active = 1
