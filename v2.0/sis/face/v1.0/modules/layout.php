...
if (in_array($page, $arrPage)) {
	switch ($page) {
		...
		case "select-store-cheeks":
			include("store/sunnies-product-face.php");
			break;
		case "select-store-nails":
		case "select-store-sets":
			include("store/sunnies-product-default.php");
			break;
		case "select-merch":
