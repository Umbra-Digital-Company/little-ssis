...
//								
	...
	if( ($_POST['remarks']==' ' || $_POST['remarks']=='') && $_POST['update_type']=='reject'){
		...
		echo "<script> window.alert('Please enter remarks before rejecting');window.location.href='/list'; </script>";
	}else{
		echo "<script> window.alert('Succesfully Updated');	window.location.href='/list'; </script>";
	}
