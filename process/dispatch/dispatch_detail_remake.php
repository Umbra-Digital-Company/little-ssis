...
<form class="dispatch-form" action="../process/dispatch/dispatch_process_remake.php" method="POST" name="form-dispatch">
	...
	<div class="canvas-holder text-center">
		...
		<div class="form-group dispatch-staff-container">
			<select class="form-control text-left" name="dispatch_staff" id="dispatch_staff">
