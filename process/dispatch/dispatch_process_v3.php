...
if($_POST['dispatch_type']!='remake' && $_SESSION['store_code'] != '150' &&  $_SESSION['store_code'] != '142'  &&  $_SESSION['store_code'] != '155' && strtotime($_POST['payment_date']) >= strtotime(date('2021-05-10'))){
	function genOrderId(){
		global $conn;
	    // Generate Order NO
...
if($_POST['dispatch_type']=='remake'){
	...
	require $sDocRoot."/process/dispatch/post_purchase_email.php";
