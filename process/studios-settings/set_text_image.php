<?php
    ...
    function insertData($image_1, $image_2, $video, $text){
		...
		echo '<script type="text/javascript"> alert("Text/Images/Video successfully set"); window.location = "/studios/studios-settings"; </script>';
    }
	...
	if( $filename_video != '' && !in_array( $ext_video, $allowed )) {
		...
		$directory = $_SERVER['DOCUMENT_ROOT']."/studios/studios-settings/videos/";
