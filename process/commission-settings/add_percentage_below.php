	...
	function checkDateStoresExits($store_code){
		...
		$arrStores = array();
			$query = "SELECT 
			                ...
			                sl.store_name
			            FROM 
			                commission_percentage_below cs
	...
	foreach ($arrStoresDataSearch as $key => $value) {
		...
		$query = 	'INSERT IGNORE INTO
					...
					VALUES (
						...
						"'.mysqli_real_escape_string($conn,$_POST['sram_below_percentage']).'",
						"'.mysqli_real_escape_string($conn,$_POST['am_below_percentage']).'",
						"'.mysqli_real_escape_string($conn,$_POST['suparea_below_percentage']).'",
						"'.mysqli_real_escape_string($conn,$_POST['staff_below_percentage']).'",
