...
$query = 	'INSERT INTO
			...
			VALUES(
				...
				"'.mysqli_real_escape_string($conn, $store_zone).'",
				"'.mysqli_real_escape_string($conn, $store_name).'",
				"'.mysqli_real_escape_string($conn, $store_country).'",
                ...
                "'.mysqli_real_escape_string($conn, $store_warehouse_code).'",
                "'.mysqli_real_escape_string($conn, $store_location).'",
                "'.mysqli_real_escape_string($conn, $store_name_proper).'",
                "'.mysqli_real_escape_string($conn, $store_name_title).'",
                ...
                "'.mysqli_real_escape_string($conn, $store_time_open).'",
                "'.mysqli_real_escape_string($conn, $store_time_close).'",
				"y"
			)';
