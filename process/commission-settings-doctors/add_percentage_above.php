	...
	function checkDateStoresExits($store_code){
		...
		$arrStores = array();
			$query = "SELECT 
			                ...
			                sl.store_name
			            FROM 
			                commission_percentage_above_doctors cs
	...
	function selectLastStoreLogs($store_code){
		...
		$arrStores = array();
			$query = "SELECT 
			                id
			            FROM 
			                commission_percentage_above_doctors
			            WHERE
	...
	foreach ($arrStoresDataSearch as $key => $value) {
		...
		$query = 	'INSERT IGNORE INTO
					...
					VALUES (
						...
						"'.mysqli_real_escape_string($conn,$_POST['adoc_above_percentage']).'",
						"'.mysqli_real_escape_string($conn,$_POST['cordoc_above_percentage']).'",
