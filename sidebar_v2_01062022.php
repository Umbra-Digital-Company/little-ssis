			...
			<?php if(isset($_SESSION['user_access']['ssis'])) { ?>
				...
				<nav class="ssis-menu sidebar-menu">
					...
					<ul class="nav flex-column">
						...
						<?php if(issetVal('ssis','patient_records')==1) { ?>
...
<!-- 						<?php if(issetVal('maintenance','patients')==1) { ?>
						...
						<?php if(issetVal('ssis','profile_segmentation')==1) { ?>
						...
						<?php if(issetVal('ssis','patient_profile')==1) { ?>
						...
						<?php if(issetVal('ssis','incentives')==1) { ?>
						...
						<?php if(issetVal('ssis','incentives_doctors')==1) { ?>
						...
						<?php if(issetVal('ssis','commission_settings')==1) { ?>
						...
						<?php if(issetVal('ssis','commission_settings_doctors')==1) { ?>
