...
$filter_page = 'stock_movement_store_face';
$group_name = 'aim_face';
		...
		<div class="ssis-content">
				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/face/inventory/store/stock-movement" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline d-lg-none">
			...
			<div class="d-flex no-gutters align-items-center" id="data-filter">
				<div class="col">
					<div class="d-flex align-items-center">
						...
						<section class="ml-0 ml-md-3">
							<p class="h3 font-bold">Showing Data For Face</p>
				...
				<?php if(isset($_GET['date'])) { ?>
					...
					<a href="/face/inventory/store/stock-movement" class="mr-3 d-none d-lg-block">
						<button class="btn btn-danger" type="button">reset filter</button>
					</a>
