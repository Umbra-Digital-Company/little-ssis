...
$page = 'store';
$page_url = 'face-pullout';

$filter_page = 'pullout_store_face';
$group_name = 'aim_face';
////////////////////////////////////////////////
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<div id="inventory-receive">
				...
				<form action="/face/inventory/process/store/face_pullout.php" method="POST" id="pullout-form" autocomplete="off">
							...
							<div class="custom-card">
								<div class="row">
									<div class="col-6">
										...
										<input type="hidden" name="stock_from_id" class="form-control" value="<?= $_SESSION['user_login']['store_code'] ?>" readonly>
										<input type="text" class="form-control" value="<?= str_replace(['Mw','Mtc','Sm','Hq','Ali'],['MW','MTC','SM','HQ','ALI'],ucwords(strtolower($storeName))) ?>" readonly>
									</div>
									<div class="col-6">
										<h5 class="text-secondary font-bold font-bold">To</h5>
										<input type="hidden" name="stock_from_id" class="form-control" value="hq" readonly>
										<input type="text" class="form-control" value="Sunnies HQ" readonly>
									</div>
								</div>
						...
						<div class="col-12 col-lg-4 mt-5 mt-lg-0">
							...
							<div class="mt-3">
								<select name="reason" class="select2" required>
									...
									<option value="product_allowance">Product Allowance</option>
								</select>
							</div>
