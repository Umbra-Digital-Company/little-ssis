...
$filter_page = 'transfer_warehouse_face';
$group_name = 'aim_face';
////////////////////////////////////////////////
				...
				<div class="row align-items-start">
						...
						<div class="custom-card">
							<div class="row">
								...
								<?php 
										...
										<option value="warehouse_qa">Warehouse QA</option>
										</optgroup>
										<optgroup label="STORE NAME">
											<?php for ($i=0;$i<sizeof($arrStoresFace);$i++) { ?>
												<option value="<?= $arrStoresFace[$i]['store_id'] ?>"><?= ucwords(str_replace(['ali','mw','sm','-'], ['ALI','MW','SM',' '], strtolower($arrStoresFace[$i]['store_name']))) ?></option>
											<?php } ?>
										</optgroup>
													...
													<select name="frame_code[]" class="select2 filled frame_code" <?= ($x==0) ? 'required' : '' ?>>
														...
														<?php 
															...
															for ($i=0;$i<sizeof($arrItems);$i++) {
																...
																echo 	'<option value="'.$arrItems[$i]['product_code'].'"'.$selected.'>'.ucwords(strtolower(str_replace("-", " ", $arrItems[$i]['product_style'].' '.$arrItems[$i]['product_color']))).' ('.$arrItems[$i]['product_code'].')</option>';
					...
					<div class="col-12 col-lg-4 mt-5 mt-lg-0">
						...
						<div class="mt-4">
							...
							<input type="text" name="emp_name" class="form-control" placeholder="Full name" value="<?= getFullName() ?>" required>
						</div>
						<div class="mt-3">
