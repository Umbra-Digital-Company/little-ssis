...
$page = 'warehouse';
$page_url = 'Face Good Issue';

$filter_page = 'pullout_warehouse_face';
$group_name = 'aim_face';
////////////////////////////////////////////////
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<div id="inventory-receive">
				...
				<form action="/face/inventory/process/warehouse/face_pullout.php" method="POST" id="pullout-form" autocomplete="off">
