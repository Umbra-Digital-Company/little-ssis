...
$page = 'warehouse';
$page_url = 'inventory-request-face';
...
require $sDocRoot."/face/inventory/includes/grab_all_approval_stock_face.php";
							...
							<tbody>
								...
								<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { ?>
									...
									<tr>
										...
										<td nowrap class=""><?= $arrReceivable[$i]['admin_name'] != '' ? ucwords($arrReceivable[$i]['admin_name']) : ucwords($arrReceivable[$i]['sender_name'])  ?></td>
