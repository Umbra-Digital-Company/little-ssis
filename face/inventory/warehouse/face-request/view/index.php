...
$page = 'warehouse';
$page_url = 'face-inventory-request';

$filter_page = 'request_warehouse_face';
$group_name = 'aim_face';
////////////////////////////////////////////////
		...
		<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
			...
			<div class="ssis-content">
				...
				<div class="order-details">
					...
					<form action="/face/inventory/process/warehouse/face_transfer_request.php" method="POST" autocomplete="off">
...
<?php } else {
	...
	header('Location: /face/inventory/warehouse/face-request/');
	exit;
