						...
						<div class="col-12 col-lg-4">
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									...
									<?php } ?>									
									<a href="/face/inventory/warehouse/face-receive/receive_warehouse/" class="ml-3"><button type="button" class="btn btn-secondary">Exit</button></a>
								</div>
							</div>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { 
										...
										<tr>
											...
											<td nowrap class=""><a href="/face/inventory/warehouse/face-receive/receive_warehouse/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
