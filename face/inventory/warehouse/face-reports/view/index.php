...
$filter_page = 'reports_warehouse_face';
$group_name = 'aim_face';
////////////////////////////////////////////////
			...
			<div class="ssis-content">
				...
				<div class="order-details">
					...
					<div class="row align-items-start">
						<form class="col-12 col-lg-8" action="/face/inventory/process/warehouse/face_variance_approve.php" method="POST" autocomplete="off">
						...
						<div class="col-12 col-lg-4 mt-5 mt-lg-0">
							...
							<div class="text-center mt-5">
								<a href="/face/inventory/warehouse/face-reports/"><button class="btn btn-primary">back to history</button></a>
							</div>
...
<?php } else {
	...
	header('Location: /face/inventory/warehouse/face-reports/');
	exit;
