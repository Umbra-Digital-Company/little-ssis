        ...
        <div class="dashboard-filter">
				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/studios/inventory/lab/studios-movement/" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline d-lg-none">
			...
			<div class="d-flex no-gutters align-items-center" id="data-filter">
				...
				<?php if(isset($_GET['date'])) { ?>
					...
					<a href="/studios/inventory/lab/studios-movement/" class="d-none d-lg-block text-danger text-uppercase font-bold">
						reset filter
					</a>
