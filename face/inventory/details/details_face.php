...
if($_GET['branch']=='store'){
	if($_GET['column_header']=='DAILY SALES'){
		...
		if($_GET['filterStores']=='5000470' || $_GET['filterStores']=='5000472' || $_GET['filterStores']=='5000473'  || $_GET['filterStores']=='6008053'  || $_GET['filterStores']=='6008054'
		|| $_GET['filterStores']=='6008055'   || $_GET['filterStores']=='SF-MPWHC'){

			$GetData=	perdayStoreSales('SF-MPWHC',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'store');
		}
		else{
...
<?php if($_GET['column_header']=='DAILY SALES'){ ?>
				<table class="table-striped table-inventory" style="width:200%">
				<tr>
				<th>#</th>
