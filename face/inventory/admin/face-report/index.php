						...
						<div class="row mt-3 store-form">
							...
							<?php
								...
								for ($i=0; $i < sizeOf($arrStoresFace); $i++) { 
										...
										$curStoreName = ucwords(str_replace("u.p.", "UP", str_replace("sm", "SM", str_replace("-", " ", $arrStoresFace[$i]['store_name']))));
										$checked = checkFilter($arrStoresFace[$i]['store_id']);

										echo 	'<div class="col-12 col-md-6 mb-2">
													<div class="d-flex align-items-center">
														<input class="sr-only checkbox" name="filterStores[]" type="checkbox" id="option'.$curStoreName.'" value="'.$arrStoresFace[$i]['store_id'].'" '.$checked.'>
