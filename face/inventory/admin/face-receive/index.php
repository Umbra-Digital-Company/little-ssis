...
$page = 'admin';
$page_url = 'face-receive';

$filter_page = 'receive_admin_face';
$group_name = 'aim_face';
...
$MergeStores=array_merge($arrStore, $arrStoresFace);
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<?php if ( isset($_GET['id']) && $_GET['id'] != '' ) { ?>
				...
				<form action="/face/inventory/process/admin/face_receive.php" method="POST" id="receive-form">
							...
							<?php if ( $arrReceivableItems[0]['status']=='in transit') { ?>
								...
								<div class="mt-5">
									<div class="d-flex justify-content-end">
										<a href="/face/inventory/admin/face-receive" class="mr-3"><button type="button" class="btn btn-secondary">Exit</button></a>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { ?>
										...
										<tr>
											...
											<td nowrap class=""><a href="/face/inventory/admin/face-receive/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
