...
$page = 'admin';
$page_url = 'face-request-approval';

$filter_page = 'request_approval_admin_face';
$group_name = 'aim_face';
				...
				<div class="row align-items-start">
					...
					<div class="col-12 col-lg-4 mt-5 mt-lg-0">
						...
						<div class="mt-5 text-center">
							<a href="/face/inventory/process/admin/face_approve.php?ref=<?= $_GET['ref_num'] ?>"><button class="btn btn-primary mx-2">approve</button></a>
							<a href="/face/inventory/process/admin/face_reject.php?ref=<?= $_GET['ref_num'] ?>"><button class="btn btn-danger mx-2">reject</button></a>
						</div>
