...
$query =    "SELECT 
				...
				p51.item_code,
				IF(
					p51.item_code LIKE 'SS%',
					1,
					2
				) as 'ordering_id'
			FROM 
				poll_51_face p51
					LEFT JOIN inventory_delivery_face id
						ON id.product_code = p51.item_code
					LEFT JOIN inventory_pullout_face ip
						ON ip.product_code = p51.item_code
