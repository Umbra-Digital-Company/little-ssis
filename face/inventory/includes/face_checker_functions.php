    ...
    $query=" SELECT 
                ...
                (select coalesce(
                    ...
                    (select coalesce(
                        ...
                        '0',
                'none'
            FROM   inventory_face ip 
            LEFT JOIN poll_51_face p51 on p51.item_code=ip.product_code
...
function StoreChecker_auditor($product_code,$store_id,$date_start,$date_end){
    ...
    if($store_id=='787'  || $store_id=='788'){
        ...
        || preg_match("/PL/i", $product_code) || preg_match("/60319/i",$product_code)
                            ...
                            || preg_match("/P1/i",$product_code)  || preg_match("/H1/i",$product_code)  || preg_match("/SSVHC/i",$product_code) || preg_match("/AC/i",$product_code)  || preg_match("/SFP/i",$product_code) ){
     ...
     $query ="SELECT 
                       ...
                       'none',
                        ...
                        SELECT COALESCE( max(iaccc.date_end),0)
                            ...
                            AND
                            DATE(DATE_ADD(iib.status_date, INTERVAL 13 HOUR))=(SELECT  DATE(DATE_ADD(max(iacx2.status_date), INTERVAL 13 HOUR)) from inventory_face  iacx2 
                        ...
                        AND
                        DATE(DATE_ADD(iib.status_date, INTERVAL 13 HOUR))=(SELECT  DATE(DATE_ADD(max(iacx3.status_date), INTERVAL 13 HOUR)) from inventory_face  iacx3 
