...
$filter_page = 'receive_store_studios';
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<?php if ( isset($_GET['id']) && $_GET['id'] != '' ) { ?>
				...
				<form action="/inventory/process/store/studios_receive.php" method="POST" id="receive-form">
						...
						<div class="col-12 col-lg-4">
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									...
									<?php } ?>
									<a href="/studios/inventory/store/studios-receive/"><button type="button" class="btn btn-secondary ml-3">Exit</button></a>
								</div>
							</div>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { ?>
										...
										<tr>
											...
											<td nowrap class=""><a href="/studios/inventory/store/studios-receive/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
