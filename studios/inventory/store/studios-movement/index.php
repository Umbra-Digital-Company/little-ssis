...
$page = 'store';
$page_url = 'studios-movement';

$filter_page = 'stock_movement_store_studios';
...
// if($_SESSION['user_login']['userlvl'] != '1' && $_SESSION['user_login']['userlvl'] != '3' && $_SESSION['user_login']['position'] !== 'store') {
...
$queryMaxDate="SELECT Max(date_end),max(date_start) FROM inventory_actual_count_studios
		...
		<div class="ssis-content">
				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/studios/inventory/store/stock-movement" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline d-lg-none">
			...
			<div class="d-flex no-gutters align-items-center" id="data-filter">
				<div class="col">
					<div class="d-flex align-items-center">
						...
						<section class="ml-0 ml-md-3">
							<p class="h3 font-bold">Showing Data For Studios</p>
				...
				<?php if(isset($_GET['date'])) { ?>
					...
					<a href="/studios/inventory/store/stock-movement" class="mr-3 d-none d-lg-block">
						<button class="btn btn-danger" type="button">reset filter</button>
					</a>
			...
			<?php 
			 ...
			 $queryMaxDate="SELECT Max(date_end) FROM inventory_actual_count_studios
			where  store_audited='".$store_id."' ";
...
for ($i=0;$i<sizeof($arrPoll51_items);$i++) {
								...
								?>
								<tr class="row100 body" filterStores="<?= $_SESSION['user_login']['store_code'] ?>" product_code="<?= $arrPoll51_items[$i]["product_code"] ?>" dateStart="<?= $dateStart ?>" dateEnd="<?= $dateEnd ?>" datecurrentH ="<?= $datecurrentH ?>" dateStartpdh ="<?= $dateStartpdh ?>" dateEndpdh ="<?= $dateEndpdh ?>">
