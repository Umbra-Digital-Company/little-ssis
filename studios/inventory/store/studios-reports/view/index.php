...
$filter_page = 'reports_store_studios';
			...
			<div class="ssis-content">
				...
				<div class="order-details">
					...
					<div class="row align-items-start">
						<form class="col-12 col-lg-8" action="/inventory/process/store/studios_variance_approve.php" method="POST" autocomplete="off">
...
<?php } else {
	...
	header('Location: /inventory/store/studios-reports/');
	exit;
