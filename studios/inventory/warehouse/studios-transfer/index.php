...
$page = 'warehouse';
$page_url = 'studios-transfer';

$filter_page = 'transfer_warehouse_studios';
								...
								<?php 
										...
										<optgroup label="STORE NAME">
											<?php for ($i=0;$i<sizeof($arrStudiosStore);$i++) { ?>
												<option value="<?= $arrStudiosStore[$i]['store_id'] ?>"><?= ucwords(str_replace(['ali','mw','sm','-'], ['ALI','MW','SM',' '], strtolower($arrStudiosStore[$i]['store_name']))) ?></option>
											<?php } ?>
										</optgroup>
