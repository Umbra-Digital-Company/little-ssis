...
$filter_page = 'stock_movement_warehouse_studios';
		...
		<div class="ssis-content">
				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/studios/inventory/warehouse/studios-movement/" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline d-lg-none">
			...
			<div class="d-flex no-gutters align-items-center" id="data-filter">
				...
				<?php if(isset($_GET['date'])) { ?>
					...
					<a href="/studios/inventory/warehouse/studios-movement/" class="mr-3 d-none d-lg-block">
						<button class="btn btn-danger" type="button">reset filter</button>
					</a>
