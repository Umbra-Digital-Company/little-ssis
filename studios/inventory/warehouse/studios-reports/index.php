...
require $sDocRoot."/inventory/includes/grab_variance_report_studios.php";
// 2.0
					...
					<div class="table-default table-responsive">
						<table class="table table-striped mb-0">
							...
							<?php for($i=0;$i<sizeof($arrVariance);$i++){ ?>
								<tr>
								<td nowrap class=" text-uppercase text-center text-<?= $arrVariance[$i]['direction'] == 'out' ? 'danger' : 'success' ?>"><?= $arrVariance[$i]['direction'] ?></td>
