...
$filter_page = 'reports_warehouse_studios';
...
require $sDocRoot."/inventory/includes/grab_variance_report_details_studios.php";
			...
			<div class="ssis-content">
				...
				<div class="order-details">
					...
					<div class="row align-items-start">
						<form class="col-12 col-lg-8" action="/inventory/process/warehouse/studios_variance_approve.php" method="POST" autocomplete="off">
						...
						<div class="col-12 col-lg-4 mt-5 mt-lg-0">
							...
							<div class="mt-3">
								...
								<p class="h6 large">
									<?= ucwords(str_replace(['ali','mw','sm','mtc','-'], ['ALI','MW','SM','MTC',' '],strtolower($arrVariance[0]['stock_from_branch']))) ?>
								</p>
							</div>
							<div class="mt-3">
							...
							<div class="text-center mt-5">
								<a href="/studios/inventory/warehouse/studios-reports/"><button class="btn btn-primary">back to history</button></a>
							</div>
...
<?php } else {
	...
	header('Location: /studios/inventory/warehouse/studios-reports/');
	exit;
