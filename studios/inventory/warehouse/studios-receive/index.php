...
$page = 'warehouse';
$page_url = 'receive-studios';

$filter_page = 'receive_warehouse_studios';
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<?php if($_SESSION["store_code"]=='warehouse_qa'){?>
			...
			<div id="inventory-receive">
				...
				<form action="/inventory/process/warehouse/studios_transfer.php" method="POST" id="pullout-form" autocomplete="off">
						...
						<div class="col-12 col-lg-4">
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									<a href="/studios/inventory/warehouse/studios-receive/" class="mr-3">
		...
		<?php } else { ?>
			...
			?>
				<form action="/inventory/process/warehouse/studios_receive.php" method="POST" id="receive-form">
					<div class="row align-items-start">
						<div class="col-12 col-lg-8">
							<div class="custom-card">
								<div class="row">
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									<?php if ( $arrReceivableItems[0]['status']=='in transit') { ?>
										<button type="submit" class="btn btn-primary" id="confirmForm" disabled>receive</button>
									<?php } ?>									
									<a href="/studios/inventory/warehouse/studios-receive/" class="ml-3"><button type="button" class="btn btn-secondary">Exit</button></a>
								</div>
							</div>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { 
										...
										<tr>
											...
											<td nowrap class=""><a href="/studios/inventory/warehouse/studios-receive/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
