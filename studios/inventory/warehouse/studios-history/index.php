...
$page = 'warehouse';
$page_url = 'studios-history';

$filter_page = 'history_warehouse_studios';
				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/studios/inventory/warehouse/studios-history" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline ml-sm-3">
			...
			<div id="inventory-receive" class="mt-4">
				...
				<?php } else { ?>
					...
					<div class="mt-5 text-center">
						<a href="/studios/inventory/warehouse/studios-history" class="text-uppercase text-danger">clear search</a>
					</div>
