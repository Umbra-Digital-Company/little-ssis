...
$page = 'warehouse';
$page_url = 'Studios Good Issue';

$filter_page = 'pullout_warehouse_studios';
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<div id="inventory-receive">
				...
				<form action="/inventory/process/warehouse/studios_pullout.php" method="POST" id="pullout-form" autocomplete="off">
					<div class="row align-items-start">
						...
						<div class="col-12 col-lg-4 mt-5 mt-lg-0">
							<p class="text-primary text-uppercase font-bold">reason</p>
							<div class="mt-3">
							...
							<p class="text-primary text-uppercase font-bold mt-2">sender details</p>
							<div class="mt-4">
