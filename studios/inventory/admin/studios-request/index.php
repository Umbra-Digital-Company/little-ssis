...
if ( isset($_GET['ref_num']) && $_GET['ref_num'] != '' ) {
	...
	require $sDocRoot."/inventory/includes/grab_all_for_approval_studios.php";
			...
			<div id="inventory-receive" class="mt-4">
				...
				<?php } else { ?>
					...
					<div class="mt-5 text-center">
						<a href="/studios/inventory/admin/studios-request/" class="text-uppercase text-danger">clear search</a>
					</div>
