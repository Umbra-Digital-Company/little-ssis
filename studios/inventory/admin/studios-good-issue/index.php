...
$filter_page = 'good_issue_admin_studios';
...
<div class="row no-gutters align-items-strech flex-nowrap">
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<form action="/inventory/process/admin/studios_good_issue.php" method="POST" id="pullout-form" autocomplete="off">
						...
						<div class="custom-card">
							<div class="row">
								<div class="col-6">
									...
									<input type="hidden" name="stock_from_id" value="good_issue">
									<input type="text" value="Good Issue" class="form-control" readonly>
								</div>
								<div class="col-6">
