							...
							<?php if ( $arrReceivableItems[0]['status']=='in transit') { ?>
								...
								<div class="mt-5">
									<div class="d-flex justify-content-end">
										<a href="/studios/inventory/admin/studios-receive" class="mr-3"><button type="button" class="btn btn-secondary">Exit</button></a>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { ?>
										...
										<tr>
											...
											<td nowrap class=""><a href="/studios/inventory/admin/studios-receive/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
