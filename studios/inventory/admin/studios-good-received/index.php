...
$page = 'admin';
$page_url = 'good-received';

$filter_page = 'good_received_admin_studios';
...
<div class="row no-gutters align-items-strech flex-nowrap">
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<form action="/inventory/process/admin/studios_good_received.php" method="POST" id="pullout-form" autocomplete="off">
						...
						<div class="custom-card">
							<div class="row">
								<div class="col-6">
									...
									<select name="stock_from_id" id="stock_from_id" class="select2 form-control" required>
										<option value="">-- Select Branch --</option>
										<optgroup label="STORE NAME">
											<?php for ($i=0;$i<sizeof($arrStudiosStore);$i++) { ?>
												<option value="<?= $arrStudiosStore[$i]['store_id'] ?>"><?= ucwords(str_replace(['ali','sm','mw'],['ALI','SM','MW'],strtolower($arrStudiosStore[$i]['store_name']))) ?></option>
											<?php } ?>
										</optgroup>
								...
								<div class="col-6">
									...
									<input type="hidden" name="recipient_branch" value="good_received">
									<input type="text" value="Good Received" class="form-control" readonly>
								</div>
							</div>
