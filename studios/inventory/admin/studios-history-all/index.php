...
$page = 'history-all-studios';
$page_url = 'history-all-studios';

$filter_page = 'history_all_admin_studios';
...
require $sDocRoot."/inventory/includes/grab_all_moving_stock_global_studios.php";
				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/studios/inventory/admin/studios-history-all" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline ml-sm-3">
			...
			<div id="inventory-receive" class="mt-4">
				...
				<?php if ( !isset($_GET['ref_num']) ) { ?>
					...
					<?php } else { ?>
						...
						<div class="text-center p-4 mt-4">
							<h4>You don't have any transactions yet</h4>
						</div>
				...
				<?php } else { ?>
					...
					<div class="mt-5 text-center">
						<a href="/studios/inventory/admin/studios-history-all" class="text-uppercase text-danger">clear search</a>
					</div>
				...
				<?php if ( !empty($arrReceivable) ) { ?>
					...
					<div class="custom-card row flex-column flex-md-row no-gutters align-items-md-center justify-content-md-between">
						<div class="col-12 col-md-auto">
							<div class="d-flex align-items-center">
								<section>
									<p class="h3 font-bold">Download History</p>
									<p class="text-secondary mt-1">Click the button to download the current History.</p>
								</section>
							</div>
						</div>
						<div class="col-12 col-md-auto">
										...
										<div class="dl_btn input-group-prepend">
											<?php
												...
												foreach ($_GET as $key => $value) {
													$en = ($parameters != "") ? "&" : "";
														$parameters .= $en.$key."=".$value;
												}
												$url = '/process/inventory/history/history_all_csv.php?'.$parameters;
											?>
									    	<a href="<?= $url ?>"><span class="btn btn-primary text-white input-group-text" id="btn_download_all">Download</span></a>
									  	</div>
									</div>
								</section>
							</div>
