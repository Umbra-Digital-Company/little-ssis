...
$filter_page = 'stock_movement_audit_studios';
		...
		<div class="ssis-content">
				...
				<form method="GET" class="filter-body">
								...
								<select name="filterStores" id="filterStores" class="select2 form-control">
									...
									<optgroup label="STORE NAME">
										<?php for ($i=0;$i<sizeof($arrStudiosStore);$i++) { ?>
											<option value="<?= $arrStudiosStore[$i]['store_id'] ?>" <?=$branchtype==$arrStudiosStore[$i]['store_id'] ? 'selected' : '' ?>><?= ucwords(str_replace(['ali','sm','mw'],['ALI','SM','MW'],strtolower($arrStudiosStore[$i]['store_name']))) ?></option>
										<?php } ?>
									</optgroup>
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/studios/inventory/audit/studios-movement/" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline d-lg-none">
			...
			<div class="d-flex no-gutters align-items-center" id="data-filter">
				<div class="col">
					<div class="d-flex align-items-center">
						...
						<section class="ml-0 ml-md-3">
							<p class="h3 font-bold"><?= ucwords(str_replace(['ali','sm','mw','mtc','hq','-'],['ALI','SM','MW','MTC','HQ',' '],strtolower($branchName))) ?>   (Studios)  </p>
				...
				<?php if(isset($_GET['date'])) { ?>
					...
					<a href="/studios/inventory/audit/studios-movement/" class="d-none d-lg-block text-danger text-uppercase font-bold">
						reset filter
					</a>
