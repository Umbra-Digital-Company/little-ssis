...
require $sDocRoot."/sidebar_studios_test.php";
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<div id="total-revenue" class="custom-card lg">
				...
				<div id="bar_chart_rev_breakdown" style="min-height: <?= $breakdownH ?>px"></div>				
			...
			<?php if($_GET['date'] == 'month' || $customMonth || $_GET['date'] == 'pmonth'  ) { ?>
...
<script type="text/javascript">	
	...
	$(document).ready(function() {		
		...
		<?php
			...
			elseif($_GET['date'] == 'custom' && $customMonth) {
