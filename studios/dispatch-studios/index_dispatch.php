...
require $sDocRoot."/includes/v2/navbar_studios_v2.php";
...
<div class="ssis-2" id="ssis-admin">
...
?>
		...
		<div id="ssis-content" class="dispatch-home">
			...
			<section class="ssis-section">
	            ...
	            <div class="section-outter closed mt-4">				
...
<!-- ===================================================================================================================================== -->
			...
			<script>		
				$('#topbar').children('div').children('div').children('div').eq(0).append('<span id="store_display"><h2><?= str_replace("Up Town Center", "UP Town Center", str_replace("Sm ", "SM ", str_replace("Mw ", "MW ", str_replace("Ali ", "ALI ", ucwords( strtolower($storeNameHeader) ))))); ?></h2></span>');
