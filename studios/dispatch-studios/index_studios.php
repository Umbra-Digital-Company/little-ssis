								...
								<select class="filter-select" id="filterStore">
									...
									<?php 
										...
										for($i=0; $i<sizeof($arrStore); $i++){
											...
											$storeName = str_replace("Sm ", "SM ", ucwords(str_replace('-',' ',$arrStore[$i]["store_name"])));
											$storeID = $arrStore[$i]['store_id'];
											...
											echo '<option value="'.$storeID.'"'.$sel.'>'.$storeName.'</option>';
...
// alert(orderidspecs);
				...
				$("#btnSearch").click(function() {
					...
					filterURL = "/dispatch_studios/?search=" + filterA + "&page=1";
				...
				$('#filterPage').on('change', function() {
					...
					filterURL = "/dispatch_studios/?search=" + filterA + "&page=" + filterB;
					filterURL += '<?= (isset($_GET["store"])) ? "&store=".$_GET["store"] : "" ?>';
					window.location.href = filterURL;
				...
				$(document).ready(function(){					
				 ...
				 //    remakeOrder();
					...
					$('#filterStore').on('change', function() {
						...
						filterURL = "/dispatch_studios/?store=" + filterStore;
