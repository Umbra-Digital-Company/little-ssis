...
require $sDocRoot."/studios/dispatch-studios/dispatch_receivable.php";
require $sDocRoot."/includes/v2/navbar_studios_v3.php";
...
?>
		<?php 
			...
			if(!isset($_SESSION['dashboard_login'])){
				...
				echo "<script>window.location = 'https://www.sunniesstore.com/'</script>";	
	            ...
	            <div class="section-outter closed">				
					...
					<div class="row no-gutters align-items-top justify-content-center row-filter-bar">	
		            	...
		            	<div class="row no-gutters justify-content-between align-items-center">
                            ...
                            <div class="col-4 col-lg-4 pr-2">
            					<div class="input-group mb-3">
                                <input type="date" class="form-control" aria-describedby="date_from" id="date_from" value="<?php echo (isset($_GET['date_from'])) ? urldecode($_GET['date_from']) : '' ; ?>">
								</div>
        					</div>
                            ...
                            <div class="col-4 col-lg-4">
								...
								<div class="input-group mb-3 pl-1">
								    <input type="date" class="form-control" aria-describedby="date_to" id="date_to" value="<?php echo (isset($_GET['date_to'])) ? urldecode($_GET['date_to']) : '' ; ?>">
									<div class="input-group-append">
                                        <button type="button" class="btn btn-primary" id="btnSearch" style="border-top-right-radius: 15px; border-bottom-right-radius: 15px;"><i class="zmdi zmdi-search zmdi-hc-2x"></i></button>
                                    </div>
								</div>

    						</div>

							<!-- <input type="text"name="search" class="search form-control col mr-2" id="search" placeholder="Search..." value="<?= $searchVal ?>">
                            <input type="date" class="form-control col" name="date_from" id="date_from">
...
// alert(orderidspecs);
				...
				$("#btnSearch").click(function() {
                    ...
                    filterURL = "?search=" + filterA + "&page=1" + "&date_from=" + $('#date_from').val() + "&date_to=" + $('#date_to').val();
					filterURL += '<?= (isset($_GET["store"])) ? "&store=".$_GET["store"] : "" ?>';
