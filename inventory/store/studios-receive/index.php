						...
						<div class="col-12 col-lg-4">
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									...
									<?php } ?>
									<a href="/inventory/store/studios-receive/"><button type="button" class="btn btn-secondary ml-3">Exit</button></a>
								</div>
							</div>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { ?>
										...
										<tr>
											...
											<td nowrap class=""><a href="/inventory/store/studios-receive/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
