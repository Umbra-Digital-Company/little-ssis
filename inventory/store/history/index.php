				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/inventory/store/history/" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline ml-sm-3">
			...
			<div id="inventory-receive" class="mt-4">
				...
				<?php } else { ?>
					...
					<div class="mt-5 text-center">
						<a href="/inventory/store/history/" class="text-uppercase text-danger">clear search</a>
					</div>
