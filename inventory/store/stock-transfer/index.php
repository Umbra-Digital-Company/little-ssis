...
$filter_page = 'stock_transfer_store';
					...
					<div class="col-12 col-lg-4 mt-5 mt-lg-0">
						...
						<div class="mt-3">
							...
							<div class="custom-card">
								<div class="canvas-holder text-center">
									<canvas id="thecanvasNew" width="475" height="148" border="1"></canvas>
						...
						<div class="mt-5">
							<div class="d-flex justify-content-center">
								<button type="submit" class="btn btn-primary" id="confirmFormNew" style="display: none;">transfer stock</button>
							</div>
						</div>
					</div>
				</div>
