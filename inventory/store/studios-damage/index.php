...
$page = 'store';
$page_url = 'studios-damage';

$filter_page = 'damage_store_studios';
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<div id="inventory-receive">
				<form action="/inventory/process/store/studios_damage.php" method="POST" id="damage-form" autocomplete="off">
