...
$filter_page = 'inventory_lookup_lab';
...
if(isset($_GET['frame_code'])){
   ...
   $branches ='warehouse';
   $FrameData[$_GET['frame_code']]["warehouse"] = WarehouseChecker_smr("z",$dateStart,$dateEnd);
}
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<div id="inventory-receive" style="max-width: 768px">
				...
				<form action="/inventory/lab/inventory-lookup/" method="GET" id="request-form">
