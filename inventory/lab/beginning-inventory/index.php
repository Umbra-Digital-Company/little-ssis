...
for ($i=0; $i < sizeOf($arrLab); $i++) { 
	...
	if($arrLab[$i]['store_id'] == $_SESSION['user_login']['store_code']) {
...
<div class="row no-gutters align-items-strech flex-nowrap">
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<form action="/inventory/process/lab/beginning_inventory.php" method="POST" id="pullout-form" autocomplete="off">
