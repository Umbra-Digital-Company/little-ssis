...
$filter_page = 'stock_movement_lab';
...
require $sDocRoot."/inventory/includes/w_admin_functionv12.php";
					...
					<table class="table-striped table-inventory">
						<thead>
							<tr class="row100 head">
								<th class="cell100 text-uppercase small column1">SKU <span style="float: right;" class="loading_all"><img src="/images/loading_gray.gif" width="30px" height="30px"></th>
