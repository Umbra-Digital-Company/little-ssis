				...
				<form method="GET" class="filter-body">
					...
					<div class="text-center mt-5 pb-5">
						...
						<?php if(isset($_GET['date'])) { ?>
							...
							<a href="/inventory/lab/history/" class="ml-0 mt-3 mt-sm-0 mt-sm-3 d-block d-sm-inline ml-sm-3">
			...
			<div class="d-flex no-gutters align-items-center" id="data-filter">
				...
				<?php 
					 if ( isset($_GET['ref_num']) ) {
						 $reference_number_get=$_GET['ref_num'];
					 }else{
						$reference_number_get="";
					 }
				?>
				<form method="GET" class="d-flex" style="width:500px">
					<input type="text"name="ref_num" class="search form-control col" placeholder="Search reference number" value="<?= $reference_number_get!='' ? $reference_number_get : '' ?>">
			...
			<div id="inventory-receive" class="mt-4">
				...
				<?php } else { ?>
					...
					<div class="mt-5 text-center">
						<a href="/inventory/lab/history/" class="text-uppercase text-danger">clear search</a>
					</div>
