				...
				<div class="row align-items-start">
					...
					<div class="col-12 col-lg-4 mt-5 mt-lg-0">
						...
						<div class="mt-3">
							...
							<p class="h6 large">
								<?php if ($arrReceivable[0]['admin_id']=='overseer' && $arrReceivable[0]['sender_id']=='') {
									echo ucwords(strtolower($arrReceivable[0]['admin_name']));
								} elseif ($arrReceivable[0]['admin_id']=='overseer' && $arrReceivable[0]['sender_id']=='warehouse') {
									echo ucwords(strtolower($arrReceivable[0]['sender_name']));
								} else {
						...
						<?php if ( $arrReceivable[0]['status'] == 'received' ) { ?>
							...
							<div class="mt-3">
								...
								<p class="h6 large">
									<?= ucwords(strtolower($arrReceivable[0]['receiver_first_name'].' '.$arrReceivable[0]['receiver_last_name'])) ?>
								</p>
							</div>
							<div class="mt-3">
								<h5 class="text-secondary font-bold">Signature</h5>
