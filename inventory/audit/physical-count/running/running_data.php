<?php
	...
	require $sDocRoot."/inventory/includes/checker_functionsv8.php";
	...
	if($_GET['filterStores'] != ''){
		...
		}elseif($_GET['branch']=='warehouse_qa'){
			$running_data = WarehouseChecker_auditor_qa($_GET['product_code'],$_GET['ds'],$_GET['de']); 

		}
        elseif($_GET['branch']=='warehouse_damage'){
			$running_data = WarehouseChecker_auditor_damage($_GET['product_code'],$_GET['ds'],$_GET['de']); 
