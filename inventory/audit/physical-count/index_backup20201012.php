...
if ( isset($_GET['filterStores']) && $_GET['filterStores'] != '' ) {
	...
	require $sDocRoot."/inventory/includes/checker_functionsv2.php";
			...
			<div class="d-none">
									<?php 
										...
										if($branchType=='warehouse'){
												$running_product[$arrPoll51_items[$i]['product_code']] = WarehouseChecker_auditor($running_product[$arrPoll51_items[$i]['product_code']],$_GET['ds'],$_GET['de']); 
												sleep(2);
										...
										<tr class="row100 body">
											...
											<td style="max-width:100px;min-width:100px;width:100px" nowrap class="cell100 small text-center">
												...
												<input type="hidden" name="running[]" value="<?php echo $running_product[$arrPoll51_items[$i]['product_code']]; ?>">							
