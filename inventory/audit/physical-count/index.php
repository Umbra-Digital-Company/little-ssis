...
if(isset($_GET['filterStores'])){
    ...
    elseif($_GET['filterStores']=='warehouse_qa'){
		...
		$branchType = 'warehouse_qa';
		$branchName = 'warehouse_qa';
	
	}elseif($_GET['filterStores']=='warehouse_damage'){

		$branchType = 'warehouse_damage';
		$branchName = 'warehouse_damage';
						...
						<form method="GET">
							...
							<div class="form-group">
								...
								<select name="filterStores" id="id" class="select2 form-control" required>
                                    ...
                                    <option value="warehouse_qa" <?= (isset($_GET['filterStores']) && $_GET['filterStores']=='warehouse_qa') ? 'selected' : '' ?>>Warehouse QA</option>
                                    <option value="warehouse_damage" <?= (isset($_GET['filterStores']) && $_GET['filterStores']=='warehouse_damage') ? 'selected' : '' ?>>Warehouse Damage</option>
