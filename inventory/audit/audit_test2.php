...
require $sDocRoot."/inventory/includes/grab_poll_51_new.php";
...
for ($i=0;$i<sizeof($arrPoll51_items);$i++) {
								...
								if(isset($_GET['filterStores'])){
									...
									if($arrPoll51_items[$i]["product_code"]=='SS1069-C163M'){
										echo "<pre>";
										print_r($FrameData[$arrPoll51_items[$i]["product_code"]]);
										echo "</pre>";
									}	
							...
							<tr class="row100 body">
									...
									<?php 
											...
											$FrameData[$arrPoll51_items[$i]["product_code"]][0]['sales_deduct_physical'] =='0' 
											 ){
	...
	// echo "<br>";
										...
										if(strpos($FrameData[$arrPoll51_items[$i]["product_code"]][0]["past_variance"],"-")){
														...
														if(  ( $FrameData[$arrPoll51_items[$i]["product_code"]][0]["audit_date"] >= $FrameData[$arrPoll51_items[$i]["product_code"]][0]["stock_transfer_status_date"] 
														  ...
														  +$FrameData[$arrPoll51_items[$i]["product_code"]][0]["stock_transfer_in_past"] +$FrameData[$arrPoll51_items[$i]["product_code"]][0]["interbranch_in_past"];
