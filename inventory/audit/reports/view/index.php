...
require $sDocRoot."/inventory/includes/grab_all_auditor_reports_specific.php";
// 2.0
					...
					<div class="col-12 col-lg-4">
						...
						<div class="mt-5">
							<div class="d-flex justify-content-center">
								<a href="/inventory/audit/reports/" class="mr-3"><button type="button" class="btn btn-secondary">return to reports</button></a>
							</div>
						</div>
					</div>
