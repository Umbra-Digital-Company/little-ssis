						...
						<table class="table table-striped mb-0">
							...
							<?php for($i=0;$i<sizeof($arrVarianceReport);$i++){ ?>
								<tr>
									...
									<td nowrap class=""><a href="/inventory/audit/studios-reports/view/?id=<?= $arrVarianceReport[$i]['branch_id'] ?>&date=<?= $arrVarianceReport[$i]['date_end'] ?>" class="text-primary text-uppercase font-weight-bold">view</a></td>
								</tr>
							<?php } ?>
							</tbody>
						</table>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btn_search').on('click', function(){
			...
			window.location ='https://sunniessystems.com/inventory/audit/studios-reports/'+search;
		});
