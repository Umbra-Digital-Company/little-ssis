...
for ($i=0;$i<sizeof($arrPoll51_items);$i++) {
	$beg_inventory="0";
							...
							<tr class="row100 body">
									<th nowrap class="cell100 small column1 " sku_desc ="<?= $arrPoll51_items[$i]['product_style']?>">
										<?= $arrPoll51_items[$i]['product_style']?>
									...
									<?php 
											...
											$FrameData[$arrPoll51_items[$i]["product_code"]][0]['transit_out_c'] =='0' 
												...
												$beg_inventoryfloat= "0";
												 $beg_inventoryfloat += $FrameData[$arrPoll51_items[$i]["product_code"]][0]["past_variance_2"];
