...
//     $arrXSalesDate[$i]=$arrDailySales[$i]["payment_date"];
                ...
                // echo $arrSalesDay[$arrFrames[$i]['product_code']]["total_frame"];
								...
								echo $arrFrames[$i]["stock_transfer_in_c"];
									...
									<td nowrap class="cell100 small text-center"><?php
											...
											$arrFrames[$i]["interbranch_out_c"]-$arrFrames[$i]["damage_c"]-$arrFrames[$i]["pullout_c"]-$tot_sale[$arrFrames[$i]['product_code']]; 
											// -$sale_frame;
											echo $runningtotal;
