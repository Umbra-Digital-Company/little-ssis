			...
			<div class="order-details">
				...
				<!-- <pre style="height:300px;overflow:scroll;"><?= print_r($arrReceivable) ?></pre> -->
						...
						<div class="mt-5 text-center">
							<a href="/inventory/process/admin/approve.php?ref=<?= $_GET['ref_num'] ?>"><button class="btn btn-primary mx-2">approve</button></a>
							<a href="/inventory/process/admin/reject.php?ref=<?= $_GET['ref_num'] ?>"><button class="btn btn-danger mx-2">reject</button></a>
						</div>
