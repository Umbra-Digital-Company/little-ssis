...
$filter_page = 'good_issue_warehouse';
	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<div id="inventory-receive">
				...
				<form action="/inventory/process/warehouse/pulloutv3.php" method="POST" id="pullout-form" autocomplete="off">
					<div class="row align-items-start">
							...
							<div class="custom-card">
								<div class="row">
									<div class="col-6">
										...
										<!-- <input type="text" name="stock_from_id" class="text-capitalize form-control" value="warehouse" readonly> -->

                                        <select name="stock_from_id"  class="text-capitalize form-control">
                                        <option value="warehouse">Warehouse</option>
										<optgroup label="LAB NAME">
                                        <option value="6981YR1OBFVPK2V40HY8">MTC Makati</option>
										<option value="CALLEIUHYTVLOQASDFJ">MTC Calle</option>
										</optgroup>
									...
									<div class="col-6">
										<h5 class="text-secondary font-bold font-bold">Department : </h5>
										<input type="hidden" name="stock_to_id" class="form-control" value="hq" readonly>
                                        <select  name="stock_to_id" class="form-control">  
                                        <optgroup label="Select Department">
                                        <option value="Marketing" >Marketing </option>
                                            <option value="PR" >PR </option>
                                            <option value="Product Dev" >Product Dev </option>
                                            <option value="HR" >HR </option>
                                            <option value="Directors Office" >Director's Office </option>
								...
								<div class="text-center mt-3">
									<a href="#" class="text-primary text-uppercase for-pullout" id="add-new-row-item">
						...
						<div class="col-12 col-lg-4 mt-5 mt-lg-0">
							<p class="text-primary text-uppercase font-bold"><u>requester details</u></p>
							<p class="text-primary font-bold mt-3">Reason</p>
							<div>
								<select name="reason" class="select2" required>
									<option value="">-- Select Reason --</option>
									<option value="Seeding" >Seeding </option>
                                    <option value="Photoshoot" >Photoshoot </option>
                                    <option value="Giveaway" >Giveaway </option>
                                    <option value="Product Dev" >Product Dev </option>
                                    <option value="Product Allowance" >Product Allowance </option>
                                    <option value="Director's Pullout" >Director's Pullout </option>
                                    <option value="Others" >Others </option>
								</select>
							</div>
                           
							<div class="mt-3">
								<h5 class="text-primary font-bold"> Requestor Name</h5>
							
								<input type="text" name="requestor_name" class="form-control" placeholder="Full name" required>
							</div>

							<p class="text-primary text-uppercase font-bold mt-5"><u>sender details</u></p>
							<div class="mt-3">
								<h5 class="text-primary font-bold">Employee Name</h5>
								<input type="hidden" name="emp_id"  value="<?= $_SESSION['store_code'] ?>">
								<input type="text" name="emp_name" class="form-control" placeholder="Full name" required>
							</div>

                            
							<div class="mt-3">
								<h5 class="text-primary font-bold">Additional message</h5>
								<textarea name="sender_remarks" id="senderRemarks" class="form-control textarea"></textarea>
							</div>
							<div class="mt-3">
								<h5 class="text-primary font-bold">Signature</h5>
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									<button type="submit" class="btn btn-primary" id="confirmForm" disabled>pullout</button>
								</div>
							</div>
						</div>
					</div>
