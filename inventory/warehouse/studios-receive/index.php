						...
						<div class="col-12 col-lg-4">
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									<a href="/inventory/warehouse/studios-receive/" class="mr-3">
							...
							<div class="mt-5">
								<div class="d-flex justify-content-end">
									<?php if ( $arrReceivableItems[0]['status']=='in transit') { ?>
										<button type="submit" class="btn btn-primary" id="confirmForm" disabled>receive</button>
									<?php } ?>									
									<a href="/inventory/warehouse/studios-receive/" class="ml-3"><button type="button" class="btn btn-secondary">Exit</button></a>
								</div>
							</div>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { 
										...
										<tr>
											...
											<td nowrap class=""><a href="/inventory/warehouse/studios-receive/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
