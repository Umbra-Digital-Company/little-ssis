...
$filter_page = 'variance_report_warehouse';
...
require $sDocRoot."/inventory/includes/grab_variance_report_details.php";
			...
			<div class="ssis-content">
				...
				<div class="order-details">
					...
					<div class="row align-items-start">
						<form class="col-12 col-lg-8" action="/inventory/process/warehouse/variance_approve.php" method="POST" autocomplete="off">
						...
						<div class="col-12 col-lg-4 mt-5 mt-lg-0">
							...
							<div class="text-center mt-5">
								<a href="/inventory/warehouse/reports/"><button class="btn btn-primary">back to history</button></a>
							</div>
...
<?php } else {
	...
	header('Location: /inventory/warehouse/reports/');
	exit;
