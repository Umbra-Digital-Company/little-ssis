...
function labChecker_smr($product_code,$store_id,$date_start,$date_end){
    ...
    || preg_match("/PL/i", $product_code) || preg_match("/60319/i",$product_code)
                        ...
                        || preg_match("/AFC/i",$product_code) || preg_match("/MSCL/i",$product_code) || preg_match("/SDB/i",$product_code)   || preg_match("/SSWP/i",$product_code)  || preg_match("/SWB/i",$product_code)   ){
