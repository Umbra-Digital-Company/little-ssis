...
function StoreChecker_auditor($product_code,$store_id,$date_start,$date_end){
    ...
    if($store_id=='787'  || $store_id=='788'){
        ...
        elseif($store_id=='151'){
            ...
            AND (
                                  os.lens_option='without prescription'
                                    OR
                                    os.lens_code IN (
                                        'L001','L002','L045','L013', 'L014', 'L015', 'L016', 'L018', 'L020', 'L021', 'L022', 'L023', 'L024', 'L029', 'L030', 'L031', 'L032', 'L033','SO1001', 'L049', 'L050', 'L051', 'L052', 'L053','SO001','SO002','SO003'
                                    )
                        ) 
        ...
        AND (
                        os.lens_option='without prescription'
                        OR
                        os.lens_code IN ('L013', 'L014', 'L015', 'L016', 'L018', 'L020', 'L021', 'L022', 'L023', 'L024', 'L029', 'L030', 'L031', 'L032', 'L033','SO1001', 'L049', 'L050', 'L051', 'L052', 'L053','SO001','SO002','SO003')
            ) 
            and  os.product_code!='F100' 
            and  os.product_code!='S100' 
         ...
         AND (
                        (
                            (os.lens_option='with prescription' )
                                AND
                                os.lens_code NOT IN ('L013', 'L014', 'L015', 'L016', 'L018', 'L020', 'L021', 'L022', 'L023', 'L024', 'L029', 'L030', 'L031', 'L032',
                            ...
                            ||  ( $arrInvLook[0]["audit_date"] <= $arrInvLook[0]["interbranch_in_past_date"])
                                ...
                                // echo "cccc";
                                                    ...
                                                    if(( $arrInvLook[0]["audit_date"] <=$arrInvLook[0]["pullout_past_date"]) ){
                                                        $pullout_past = $arrInvLook[0]["pullout_past_date"];
