...
if(isset($_GET['search']) && $_GET['search'] !='' && !empty($arrSearch)) {
	$querySearch .= " WHERE sl.store_name LIKE '%".$_GET['search']."%' OR ll.lab_name LIKE '%".$_GET['search']."%' ";
...
$query =    "SELECT 
				...
				CASE
					...
					WHEN i.store_audited = 'warehouse_damage' THEN 'warehouse_damage'
					WHEN i.store_audited = 'warehouse_qa' THEN 'warehouse_qa'
