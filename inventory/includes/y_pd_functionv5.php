...
function perdayStoreSales($store_id,$product_code,$date_start,$date_end,$branch_type){
    ...
    global $conn;
           ...
           if($branch_type=='store'){
                                    ...
                                    || preg_match("/SDB/i",$product_code)  || preg_match("/SSWP/i",$product_code) || preg_match("/SWB/i",$product_code) || preg_match("/SC/i",$product_code)
                                                    ...
                                                    elseif($store_id=='151'){
                                                        ...
                                                        AND (        
                                                                    ...
                                                                    and  os.product_upgrade!='sunnies_studios' 
                                                            ";
                                            // 'ML0001', 'ML0002', 'ML0045', 'Ml0013','ML0014','ML0015','ML0029','ML0030'
                                                    }
                                                    else{
                                                        $reRoute=" 
                    ...
                    //             echo 
                                   $query ="SELECT if( os.packaging_for!='' && packaging_stock='lab',
                                            ...
                                            if($store_id=='6981YR1OBFVPK2V40HY8'){
                                                ...
                                                // ) ";
                                                $KCC="   AND   '1'= CASE WHEN o.store_id='151' AND os.lens_code  IN ('L001','L002','L045','L013', 'L014', 'L015', 'L017', 'L016', 'L018', 
