...
function StoreChecker_auditor($product_code,$store_id,$date_start,$date_end){
    ...
    if($store_id=='787'  || $store_id=='788'){
        ...
        elseif($store_id=='151'){
            $reRoute=" AND  os.lens_code!='L035'
            AND (
                                  os.lens_option='without prescription'
                                    OR
                                    os.lens_code IN (
                                        'L001','L002','L045', 'L014', 'L015', 'L016', 'L018', 'L020', 'L021', 'L022', 'L023', 'L024', 'L029', 'L030', 'L031', 'L032',
        ...
        AND (
                        os.lens_option='without prescription'
                        OR
                        os.lens_code IN ('L013', 'L014', 'L015', 'L016', 'L018', 'L020', 'L021', 'L022', 'L023', 'L024', 'L029', 'L030',
     ...
     $query ="SELECT 
                        ...
                        ( SELECT if( os.packaging_for!='' && packaging_stock!='store',
                                        ...
                                        count(po_number))
                                                   ...
                                                   ". $carekits."  ='".$product_code."'
                                                    ".$reRoute." 
                                                    AND   o.origin_branch=sls.store_id    
                                                )  as sales,
                        sls.phone_number,
...
function labChecker_auditor($product_code,$store_id,$date_start,$date_end){
    ...
    || preg_match("/PL/i", $product_code) || preg_match("/60319/i",$product_code)
                        ...
                        || preg_match("/MSCL/i",$product_code)  ){
                            ...
                            $packaging_for= " (packaging_for!='' AND packaging_stock='lab' AND xsl.lab_id='".$store_id."' ) OR ";
    ...
    if($store_id=='6981YR1OBFVPK2V40HY8'){
        ...
        // ) ";
        $KCC="   AND   '1'= CASE WHEN o.store_id='151' AND os.lens_code  IN ('L001','L002','L045','L013', 'L014', 'L015', 'L016', 'L018', 
         ...
         AND ( ".$packaging_for."
                            (
                                (os.lens_option='with prescription' )
                                    AND
                                    os.lens_code NOT IN ('L013', 'L014', 'L015', 'L016', 'L018', 'L020', 'L021', 'L022', 'L023', 'L024', 'L029', 'L030', 'L031', 'L032', 'L033',
