...
function WarehouseChecker_smrx($product_Code,$date_start,$date_end) {
...
function WarehouseChecker_smr_damagex($product_Code,$date_start,$date_end) {
...
function WarehouseChecker_smr_qax($product_Code,$date_start,$date_end) {
...
function storeChecker_smr($product_code,$store_id,$date_start,$date_end){
    ...
    $query=" SELECT 
               ...
               coalesce(pactual.input_count,0) as beginventory
            FROM    poll_51_studios_new p51
            LEFT JOIN inventory_actual_count_studios pactual ON pactual.store_audited ='".$store_id."'
            AND pactual.product_code=p51.product_code  AND pactual.date_end= (SELECT max(iacx.date_end) FROM inventory_actual_count_studios iacx 
...
function storeChecker_smr_VSx($product_code,$store_id,$date_start,$date_end){
...
function storeChecker_smr_VS($product_code,$store_id,$date_start,$date_end){
    ...
    $query=" SELECT 
            ...
            LEFT JOIN store_codes_studios sls on sls.store_code='".$store_id."'
                       WHERE p51.product_code='".$product_code."'
                    AND pactual.date_end= (SELECT max(iacx.date_end) FROM inventory_actual_count_studios iacx 
                                            WHERE iacx.store_audited ='".$store_id."'
                                            AND iacx.product_code='".$product_code."'
                                            AND iacx.date_end<'".$date_start."' 
                                        ) AND pactual.product_code='".$product_code."' 
...
function storeChecker_smr_MSx($product_code,$store_id,$date_start,$date_end){
