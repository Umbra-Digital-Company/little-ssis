	...
	<div id="ssis-main" class="col <?= str_replace(' ','-',$page_url) ?>">
		...
		<div class="ssis-content">
			...
			<?php if ( isset($_GET['id']) && $_GET['id'] != '' ) { ?>
				...
				<form action="/inventory/process/admin/receive.php" method="POST" id="receive-form">
							...
							<?php if ( $arrReceivableItems[0]['status']=='in transit') { ?>
								...
								<div class="mt-5">
									<div class="d-flex justify-content-end">
										<a href="/inventory/admin/receive/" class="mr-3"><button type="button" class="btn btn-secondary">Exit</button></a>
								...
								<tbody>
									...
									<?php for ( $i=0; $i<sizeof($arrReceivable); $i++ ) { ?>
										...
										<tr>
											...
											<td nowrap class=""><a href="/inventory/admin/receive/?id=<?= $arrReceivable[$i]['reference_number'] ?>" class="text-success text-uppercase font-weight-bold"><?= $arrReceivable[$i]['status']=='in transit' ? 'receive' : 'view' ?></a></td>
										</tr>
