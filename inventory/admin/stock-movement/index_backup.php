	   ...
	   $FrameData[$arrPoll51_items[$i]["product_code"]]= WarehouseChecker_smr($arrPoll51_items[$i]["product_code"],$dateStart,$dateEnd);
							...
							<tr class="row100 body">
									...
									<?php 
											...
											// if(in_array($arrPoll51_items[$i]['product_code'],$arrActualX3)){
											// 	$beg_inventory = $FrameData[$arrPoll51_items[$i]["product_code"]][0]["past_variance"];
											// }
											// else{
											// 	$beg_inventory =$FrameData[$arrPoll51_items[$i]["product_code"]][0]["beg_inventory"]
