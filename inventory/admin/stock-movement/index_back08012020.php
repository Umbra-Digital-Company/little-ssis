	...
	// echo "<br>";
                ...
                // echo $arrSalesDay[$arrFrames[$i]['product_code']]["total_frame"];
								...
								//	} ?>
									...
									<td nowrap class="cell100 small text-center pullout_value"><?php echo $FrameData[$arrPoll51_items[$i]["product_code"]][0]['pullout_c']; ?></td>
									<?php //for ($ost=0;$ost<=$dayscount;$ost++) { ?>
										...
										// 	}
											...
											?></td>
									<?php //} ?>
									<td nowrap class="cell100 small text-center damage_value"><?= $FrameData[$arrPoll51_items[$i]["product_code"]][0]['damage_c'] ?></td>
									<?php 
