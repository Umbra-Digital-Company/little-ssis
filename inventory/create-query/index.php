		...
		<div class="ssis-content">
			...
			<form id ="create_query">
				...
				<div class="custom-card row">
					...
					$arrColumnsSales = ['Daily Sales','Stock Transfer (+)','Stock Transfer (-)','Inter Branch (+)','Inter Branch (-)','Pullout','Damage','In Transit(+)','In Transit(-)'];
				...
				<div class="custom-card row">
					...
					$arrColumnsSTP = ['Beginning Inventory','Daily Sales','Stock Transfer (+)','Stock Transfer (-)','Inter Branch (+)','Inter Branch (-)','Pullout','Damage','In Transit(+)','In Transit(-)','Running Inventory','Physical Count'];
