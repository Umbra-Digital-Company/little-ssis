...
require $sDocRoot."/inventory/includes/y_pd_functionv5.php";
...
if($_GET['branch']=='store'){
	...
	elseif($_GET['column_header']=='IN TRANSIT(-)'){
		...
		$GetData=DamageIN($_GET['filterStores'],$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'store');
	}
	...
	elseif($_GET['column_header']=='IN TRANSIT(-)'){
		...
		$GetData=DamageIN($_GET['filterStores'],$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'lab');
	}
	...
	if($_GET['column_header']=='STOCK TRANSFER (+)'){
		...
		$GetData=StockTransferPlus('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='STOCK TRANSFER (-)'){
		
		$GetData=StockTransferMinus('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='INTER BRANCH (+)'){

		$GetData=InterBranchPlus('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}
	elseif($_GET['column_header']=='INTER BRANCH (-)'){

		$GetData=InterBranchMinus('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='PULLOUT'){

		$GetData=pullout('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='DAMAGE (-)'){

		$GetData=Damage('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='IN TRANSIT(+)'){

		$GetData=inTransitIn('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}
	elseif($_GET['column_header']=='IN TRANSIT(-)'){

		$GetData=inTransitOut('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='DAMAGE (+)'){

		$GetData=DamageIN('warehouse_damage',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}
...
elseif($_GET['filterStores']=='warehouse_qa'){
	if($_GET['column_header']=='STOCK TRANSFER (+)'){
		...
		$GetData=StockTransferPlus('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='STOCK TRANSFER (-)'){
		
		$GetData=StockTransferMinus('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='INTER BRANCH (+)'){

		$GetData=InterBranchPlus('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}
	elseif($_GET['column_header']=='INTER BRANCH (-)'){

		$GetData=InterBranchMinus('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='PULLOUT'){

		$GetData=pullout('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='DAMAGE (-)'){

		$GetData=Damage('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='IN TRANSIT(+)'){
	...
	elseif($_GET['column_header']=='IN TRANSIT(-)'){
		...
		$GetData=inTransitOut('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}elseif($_GET['column_header']=='DAMAGE (+)'){

		$GetData=DamageIN('warehouse_qa',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}
	...
	elseif($_GET['column_header']=='IN TRANSIT(-)'){
		...
		$GetData=DamageIN('warehouse',$_GET['sku_code'],$_GET['dateStart'],$_GET['dateEnd'],'warehouse');
	}
...
function GetInfo($store_id){
	$info=array();
	$storelength=strlen($store_id);
	if(( $storelength=='3' || $storelength=='7') && $store_id!='auditor'){
		$info = 'store';
	}
	elseif ($store_id=='1000') {
		$info = 'store';
  ...
  $type_filter=GetInfo($_SESSION['user_login']['store_code']);
?><style>
...
<?php if($_GET['column_header']=='STOCK TRANSFER (+)' || $_GET['column_header']=='INTER BRANCH (+)' || $_GET['column_header']=='PULLOUT' || $_GET['column_header']=='DAMAGE (+)' || $_GET['column_header']=='IN TRANSIT(+)'  ){ ?>
				...
				<?php if($GetData){ ?>
					<?php for($i=0;$i<sizeof($GetData);$i++){?>
						...
						<td><?php if($type_filter=='store'){?>
								<a href='/inventory/store/history/view/?ref_num=<?=  $GetData[$i]["reference_number"]; ?>'  target='_blank'><?= $GetData[$i]["reference_number"]; ?> </a>
								<?php
						}elseif($type_filter=='laboratory'){ ?>
							<a href='/inventory/lab/history/view/?ref_num=<?=  $GetData[$i]["reference_number"]; ?>'  target='_blank'><?= $GetData[$i]["reference_number"]; ?> </a>
						<?php 	}else{ ?>

						<a href='/inventory/admin/history-all/view/?ref_num=<?= $GetData[$i]["reference_number"]; ?>' target='_blank'>	<?= $GetData[$i]["reference_number"]; ?> </a>
...
<?php if($_GET['column_header']=='STOCK TRANSFER (-)' || $_GET['column_header']=='INTER BRANCH (-)'  || $_GET['column_header']=='IN TRANSIT(-)' || $_GET['column_header']=='DAMAGE (-)'){ ?>
				<table class="table-striped table-inventory" style="width:100%">
				<tr>
				<th>#</th>
				<th>Date of Transaction</th>
