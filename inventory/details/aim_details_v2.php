...
for($c = 0; $c < count($arrColumnHeader); $c++){
	...
	if($_GET['column_header']=='DAILY SALES'){
		...
		if($GetData){
			for($i=0;$i<sizeof($GetData);$i++){
				...
				if($_GET['column_header']=='STOCK TRANSFER (+)' || $_GET['column_header']=='INTER BRANCH (+)' || $_GET['column_header']=='IN TRANSIT(+)' || $_GET['column_header']=='DAMAGE (+)' ){
	...
	}elseif($_GET['column_header']=='STOCK TRANSFER (-)' || $_GET['column_header']=='INTER BRANCH (-)'  || $_GET['column_header']=='IN TRANSIT(-)' || $_GET['column_header']=='DAMAGE (-)'){
