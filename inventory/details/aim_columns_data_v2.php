<?php
	...
	if(empty($arrData)){
		...
		$arrColumnData['aim_store_id'] = $_GET['filterStores'];
		$arrColumnData['branch_name'] = $_GET['branch_name'];
		$arrColumnData['aim_product_code'] = $_GET['product_code'];
		$arrColumnData['aim_product_name'] = $_GET['product_name'];
	}
