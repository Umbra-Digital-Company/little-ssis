...
$queryStudiosStore="SELECT `warehouse_code`, 
                            `warehouse_name`,
...
$arrStudiosStore=array();

$stmt = mysqli_stmt_init($conn);
if (mysqli_stmt_prepare($stmt, $queryStudiosStore)) {
