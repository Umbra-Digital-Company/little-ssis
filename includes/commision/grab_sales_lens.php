...
if(isset($_GET['filterStores'])){
    ...
    if(  $_GET['filterStores']!=''){
        ...
        $stores_filter_match=implode("', '",$_GET['filterStores']);

        if(preg_match("/787/i",  $stores_filter_match) || preg_match("/788/i", $stores_filter_match)){
    ...
    $store_code = "  AND o.origin_branch IN ('".implode("', '",$_GET['filterStores'])."')	";
...
// echo implode("' '",$_GET['filterStores']);


$arrComms = array();

 $query="SELECT os.po_number,
                if(o.origin_branch='788',
                pay.total,
                if( pay.total=0  || os.product_code='F100',
                    pay.total,
                         pay.total-1200
                  )
                  ),
...
if (mysqli_stmt_prepare($stmt, $query)) {
    ...
    $result10, $result11, $result12, $result13, $result14, $result15, $result16, $result17, $result18, $result19, $result20, $result21, $result22, $result23, $result24, $result25, $result26, $result27);
