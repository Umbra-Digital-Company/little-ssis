...
if($_SESSION['store_code'] == '6981YR1OBFVPK2V40HY8') {
	...
	$queryGrab = 'AND (o.laboratory = "'.$_SESSION['store_code'].'" 
					OR  ( sl.lab_id = "'.$_SESSION['store_code'].'" and o.laboratory!="0075YR1OBABCD2V40335" 	and o.laboratory!="YUUH848812ABDF82CC12" and o.laboratory!="KCCSTWE2QAM55LA11P6Q" AND o.store_id!="102" )
