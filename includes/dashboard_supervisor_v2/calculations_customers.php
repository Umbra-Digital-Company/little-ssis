...
for ($i=0; $i < sizeOf($arrCustomersInfo); $i++) { 
	...
	elseif( ( $curGender == "" || $curGender=='N/A' ) &&  $curCustomerType != 'guest') {
...
echo '<div class="loader" id="data-genders" data-male="'.$cMale.'" data-female="'.$cFemale.'" data-guest="'.$cGuest.'" data-na="'.$cNA.'"></div>';
