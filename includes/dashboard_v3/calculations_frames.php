...
if(!empty($arrReasonsFrameOnly)) {
	...
	for ($i=0; $i < sizeOf($arrReasonsFrameOnly); $i++) { 
		...
		// Set current data
		$curReason  = (isset(array_values($arrReasonsFrameOnly)[$i]['reason'])) ? strtolower(array_values($arrReasonsFrameOnly)[$i]['reason']) : '';
		$curReasonB = (isset(array_values($arrReasonsFrameOnly)[$i]['reason'])) ? array_values($arrReasonsFrameOnly)[$i]['reason'] : '';
		$curCount  =  (isset($arrReasonsFrameOnly[$curReason]['count'])) ? $arrReasonsFrameOnly[$curReason]['count'] : '';
