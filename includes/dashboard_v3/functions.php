...
$removeStoreIDs = "AND o.store_id NOT IN ('142', '1000', '900', '126', '130', '787', '788', '889','150', '999','139','155')";
$removeStoreLocations = "sl.store_id NOT IN ('142', '1000', '900', '126', '130', '787', '788','889','150', '999','139','155')";
...
function grabRevenueBreakdown() {
	...
	for ($i=0; $i < sizeOf($arrRevenue); $i++) { 
		...
		echo 				'<p class="col-1 text-left topAdjust">'.($i + 1).'</p>';
