...
if($user_type==1){
	...
	$lil_ssis="<div class='col-md-6 col-xs-12 mb-3'><a href='https://sunniesstore.com/sis/studios/v1.0/?page=store-home'><button class='btn btn-primary' style='height: 100px; width: 100%;'>".$nameSis."</button></a></div>";
