...
//////////////////////////////////////////////////////////////////////////////////// SETUP ACTIVE PAGE
function grabDefaultPages2($username) {
...
$default_pagev2 = grabDefaultPages2($username);
// echo "<pre>";
//  print_r($default_pagev2);
//  echo "<br>";
//  echo $default_pagev2['studios_link'];
//  echo "</pre>";
...
switch ($page) {
	...
	case 'lab-customer':
		...
		$nav_inventory = '/studios/inventory/lab/';
		break;
...
if($user_type==1){
	...
	$lil_ssis="<div class='col-md-6 col-xs-12 mb-3'><a href='".$default_pagev2['studios_link']."'><button class='btn btn-primary' style='height: 100px; width: 100%;'>".$nameSis."</button></a></div>";
...
$navbar_return	.=						'<div class="col-md-6 col-xs-12">
