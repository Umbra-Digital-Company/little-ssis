...
// 	$queryGrab = 'AND (os.stock_from= "'.$_SESSION['store_code'].'" 
// 					OR  ( sl.lab_id = "'.$_SESSION['store_code'].'" and os.stock_from!="0075YR1OBABCD2V40335" 	andos.stock_fromy!="YUUH848812ABDF82CC12" and os.stock_from!="KCCSTWE2QAM55LA11P6Q" AND o.store_id!="102" )
					
// 					)
// 					';

// }elseif($_SESSION['store_code'] == '0075YR1OBABCD2V40335' ) {

// 	$queryGrab = 'AND (os.stock_from= "'.$_SESSION['store_code'].'" 
//                              OR o.store_id="102" AND os.lens_code="L035")
// 					and os.stock_from!="YUUH848812ABDF82CC12"';
...
if(isset($_GET['store']) && $_GET['store'] != NULL && $_GET['store'] != 'all') {
	...
	//	$queryStore .= "  AND o.laboratory = '".$_SESSION['store_code']."' ";	
		...
		if($_SESSION['store_code'] != '0075YR1OBABCD2V40335') {
			...
			$queryStore .=  '  AND (o.laboratory = "'.$_SESSION['store_code'].'" 
                            OR (sl.lab_id = "'.$_SESSION['store_code'].'"  AND o.store_id!="102" )
                              )
...
$query = 	"SELECT
			...
			FROM
				...
				os.payment='y'  
					...
					AND os.lens_code!='SO001'
					AND os.lens_code!='SO002'
					AND os.lens_code!='SO003'
					AND os.lens_code NOT LIKE 'EL%'
					 ...
					 AND os.product_upgrade NOT LIKE '%crizal%'	
					 AND os.product_upgrade NOT LIKE '%sapphire%'	
 					".$qDispatch."
 					".$queryGrab."
 					".$queryStore."
                     ".$querySearch;
 ...
 $querypn = 	"SELECT 
				...
				DATE_ADD(os.store_dispatch_date,INTERVAL 12 HOUR),
 				(
					 ...
					 ppe.prescription_id
 					FROM 
					 profiles_prescription ppe
 					WHERE 
					 ppe.id = os.prescription_id 
						 AND ppe.profile_id=os.profile_id
...
if(isset($_GET['labfilter']) ){
	...
	$querypn .=" and os.stock_from='".$_GET['labfilter']."' ";
