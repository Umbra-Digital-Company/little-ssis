<?php   
	...
	$query = "SELECT
	                ...
	                IF(cs.area_manager != 'N/A', (SELECT CONCAT_WS(' ', first_name, CONCAT(LEFT(middle_name,1),'.'),last_name) FROM emp_table WHERE emp_id = cs.area_manager), 'N/A'),
	                IF(cs.area_supervisor != 'N/A', (SELECT CONCAT_WS(' ', first_name, CONCAT(LEFT(middle_name,1),'.'),last_name) FROM emp_table WHERE emp_id = cs.area_supervisor), 'N/A'),
	                cs.date_from,
	                cs.date_to
	            FROM 
