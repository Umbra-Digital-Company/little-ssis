...
$removeStoreIDs = "AND o.store_id NOT IN ('142', '1000', '900', '991', '126', '130', '787', '788','150', '999','139','155','022','032','040','048','409','419','426','5000447','023','033','042','055','410','421','428','997','008','029','036','043','056','412','422','429','9999','016','030','037','044','060','418','424','430','5000446','x')";
$removeStoreLocations = "sl.store_code NOT IN ('142', '1000', '900', '991', '126', '130', '787', '788','150', '999','139','155','022','032','040','048','409','419','426','5000447','023','033','042','055','410','421','428','997','008','029','036','043','056','412','422','429','9999','016','030','037','044','060','418','424','430','5000446','x')";
...
function grabRevenueBreakdown() {
	...
	for ($i=0; $i < sizeOf($arrRevenue); $i++) { 
		...
		echo 				'<a class="col-10" style="text-decoration: underline !important;" target="_BLANK" href="/studios/dashboard/studios/?filterStores%5B%5D='.$curStoreID.'&'.$date_filter.'">';
...
function grabGuestTable(){
	...
	$query ="SELECT 
					...
					FROM orders_studios o 
						LEFT JOIN orders_sunnies_studios os ON o.order_id = os.order_id
						LEFT JOIN profiles_info pi ON pi.profile_id = os.profile_id
						LEFT JOIN poll_51_studios p51 ON p51.product_code = os.product_code
						...
						WHERE
							...
							AND os.orders_specs_id!=''
							AND os.dispatch_type != 'packaging'
							AND pi.email_address LIKE '%guest@%' AND pi.email_address LIKE '%sunniesstudios.com%'
