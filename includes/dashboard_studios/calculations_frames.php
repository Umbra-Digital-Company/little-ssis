...
for ($i=0; $i < sizeOf($arrItemsMerch); $i++) { 
	...
	// Set current data
	if($arrItemsMerch[$i]['item_name_studios'] != NULL && $arrItemsMerch[$i]['item_name_studios'] != '') {

		$curItem = $arrItemsMerch[$i]['item_name_studios'];
...
if(!empty($arrItemsMerch)) {
	...
	$bestMerchItem = ucwords(strtolower($arrItemsMerch[0]['item_name_studios']));
