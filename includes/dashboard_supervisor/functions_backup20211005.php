...
function grabItemsSoldSpecs() {
	...
	$query = 	"SELECT  
				    ...
				    COUNT(
				    	case when os.product_upgrade = 'special_order' AND os.status != 'cancelled'  AND os.lens_code NOT IN ('SO003','SO002','SO001') then 1 end
	...
	if (mysqli_stmt_prepare($stmt, $query)) {
		...
		mysqli_stmt_bind_result($stmt, $result1, $result2, $result3, $result4, $result5, $result6, $result7, $result8, $result9, $result10, $result11, $result12, $result13, $result14, $result15,
		 $result16, $result17, $result18, $result19, $result20, $result21, $result22, $result23, $result24, $result25, $result26, $result27);
