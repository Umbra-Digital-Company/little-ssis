...
function grabItemsSoldSpecs() {
	...
	$query = 	"SELECT  
						...
						COUNT(
							case when os.lens_option = 'with prescription' AND os.status NOT IN ('cancelled','return','returned' )
							then 1 end
 	...
 	$query = 	"SELECT
				...
				FROM
					orders o
						...
						LEFT JOIN profiles_info pi
							ON pi.profile_id = os.profile_id
							LEFT JOIN profiles_shipping_address psa ON psa.order_id=o.order_id
