...
require $sDocRoot."/includes/dashboard_affiliate_int_v2/functions.php";
...
for ($i=0; $i < $arrMonthDays[$curMonth]; $i++) { 
	...
	if(!empty($arrMonth[$numDayID]['total'])) {

		$revDay = $arrMonth[$numDayID]['total'];
...
for ($i=0; $i < $arrMonthDays[$curMonth]; $i++) { 
	...
	if(!empty($arrMonth[$numDayID]['count'])) {

		$countDay = $arrMonth[$numDayID]['count'];
