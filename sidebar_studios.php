		...
		<div class="navigation activate-scrollbar">
				    ...
				    <select class="form-control" style="color: #fff; border-radius: 0; border: none; cursor: pointer;" onchange="location = this.value;">
				    	...
				    	<?php
						  	...
						  	foreach ($_SESSION['access_brands'] as $key => $value) { 
						  		...
						  		$selected = ($valueText == 'Sunnies Studios') ? 'selected': '';
			...
			<?php if(isset($_SESSION['user_access']['sunnies_studios'])) { ?>
				...
				<nav class="vvm-menu sidebar-menu">
					...
					<ul class="nav flex-column">
						<?php if(issetVal('sunnies_studios','dashboard_studios')==1) { ?>
							<li class="text-capitalize">
								<a href="/studios/dashboard/studios" class="<?= ($page=="dashboard") ? 'active' : '' ?>">
					...
					<?php if(issetVal('sunnies_studios','studios_settings')==1) { ?>
						<li class="text-capitalize">
							<a href="/studios/studios-settings/" class="<?= ($page=="settings") ? 'active' : '' ?>">
					...
					<?php if(issetVal('sunnies_studios','the_archive')==1) { ?>
						<li class="text-capitalize">
							<a href="/studios/the-archive/" class="<?= ($page=="the-archive") ? 'active' : '' ?>">								
								<?php $icon_archive = ( $page == 'the-archive' ) ? 'sidebar-products-active.png' : 'sidebar-products.png' ?>
								<canvas style="background-image: url(<?= get_url('images/icons/'.$icon_archive) ?>)"></canvas>
								The Archive
							</a>
						</li>
					<?php } ?>
			...
			<?php if(isset($_SESSION['user_access']['aim_studios'])) { ?>
				...
				<nav class="vvm-menu sidebar-menu">
					...
					<?php if(issetVal('aim_studios','good_issue_admin_studios')==1) { ?>
						<li class="text-capitalize">
							<a href="/studios/inventory/admin/studios-good-issue">
								<canvas style="background-image: url(<?= get_url('images/icons/sidebar-visualize.png') ?>)"></canvas>
								Good Issue
							</a>
						</li>
					<?php } ?>
					<?php if(issetVal('aim_studios','good_received_admin_studios')==1) { ?>
						<li class="text-capitalize">
							<a href="/studios/inventory/admin/studios-good-received">
								<canvas style="background-image: url(<?= get_url('images/icons/sidebar-visualize.png') ?>)"></canvas>
								Good Received
							</a>
						</li>
