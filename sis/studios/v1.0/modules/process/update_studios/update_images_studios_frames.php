...
$query =    'SELECT
                ...
                IF(
                    ...
                    s.image_url,
                    "/sis/studios/assets/images/defaults/no_specs_frame_available_b.png"
                ),
                img.image_url,
                s.main_description,
                s.tags,
...
//         $checkImage = (@getimagesize($curImageURL)) ?  $curImageURL : '/sis/studios/assets/images/defaults/no_specs_frame_available_b.png';
