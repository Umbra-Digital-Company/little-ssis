...
function insertItem(){
    ...
    $query = 	'INSERT INTO orders(
        ...
        sales_person,
        origin_branch
    ) VALUES (	?,?,?,?,?,?,"0","Cash","PHP",?,?,?) ON DUPLICATE KEY UPDATE 
...
//echo $OrderSpecsIdF;
    ...
    mysqli_stmt_bind_param($stmt, 'ssssss', $finalOrderId, $_SESSION["customer_id"], $total, $_POST['studios_product_code'], $orderSpecsIdPoNumber['po_number'], $orderSpecsIdPoNumber['order_specs_id']);
    mysqli_stmt_execute($stmt);		
    ...
    mysqli_stmt_bind_param($stmt, 'sss', $finalOrderId, $_SESSION['id'], $_SESSION['store_code']);
    mysqli_stmt_execute($stmt);		
