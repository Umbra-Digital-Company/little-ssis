	...
	<div id="navigation-tab">
		...
		<?php 
			...
			switch ( $page ) {
				...
				case 'select-free-item' 		   : $custom_title = 'Free Item'; break;
			...
			<div class="text-center">
				...
				<?php if ( $page != 'rate-us' ) { ?>
					...
					<?php } else { ?>						
						...
						<h1 class="h1 mt-2"><?= isset($arrTranslate[$custom_title]) ? $arrTranslate[$custom_title] : $custom_title ?></strong></h1>
				...
				<?php } else { ?>
					...
					<h1 class="h1 mt-2"><?= isset($arrTranslate[$custom_title]) ? $arrTranslate[$custom_title] : $custom_title ?></h1>
...
<div class="modal fade" id="myVoucher" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
                ...
                <form id="form-check-promo" method="post" >
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>
                            <button type="submit" class="btn btn-primary check_code">Check CODE</button></td>
                            <td>
