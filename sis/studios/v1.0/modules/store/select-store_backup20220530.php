...
<?php }else{ ?> 
    ...
    <!-- <div class="d-flex justify-content-end mb-3 mr-4">
        ...
        <div  class="d-flex justify-content-end" id="cart" title="Cart" style="padding: 0;">
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <input type="search" name="search_frame" id="search_frame" class="form-control filled search" placeholder="Search" style="margin-left: 20px; margin-right: 20px;" value="<?= (isset($_GET['search']) && $_GET['search'] !='') ? $_GET['search'] : '' ?>">
        <div id="toggleLayout" style="display: none;"></div>
    ...
    <div class="packages-list" style="height:66vh; overflow: auto;">
        <div class="form-row mt-1 mb-5 section-frames">
            <div class="col-12 text-center type-header">
                ...
                <a href="./?page=select-store-studios"><input type="button" class="btn btn-black" value="Shop All Sun"></a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
                <a href="./?page=select-store-studios" id="studios">
                    <img class="img-fluid" src="//cdn.shopify.com/s/files/1/0172/4383/2374/files/MOB--SUN-BOBBI-CLASSIC-TORT_709439d1-438a-461d-8eee-5fd7737ddfa2.png?v=1651475588">
                </a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
        ...
        <div class="form-row mb-5 section-antirad">
            <div class="col-12 text-center type-header">
                ...
                <a href="./?page=select-antirad"><input type="button" class="btn btn-black" value="Shop All Anti-Rad"></a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
                <a href="./?page=select-antirad" id="studios">
                    <img class="img-fluid" src="//cdn.shopify.com/s/files/1/0172/4383/2374/files/MOB--AR-NIGEL-CAVIAR_1_446db70a-0db2-42ca-bc5e-0f8d7324cdb7.png?v=1651479080">
                </a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
        ...
        <div class="form-row mb-5 section-merch">
             <div class="col-12 text-center type-header">
                ...
                <a href="./?page=select-merch"><input type="button" class="btn btn-black" value="Shop All MERCH"></a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
                <a href="./?page=select-merch" id="studios">                    
                    <div  class="card" style="height: 254px; padding: 14px; text-align: center; border-radius: 0; background-image: url(//cdn.shopify.com/s/files/1/0172/4383/2374/files/Web_-_Jan_2021_Update_Shop_Merch_de8ef9f2-1279-4c30-a490-c844abe02eb4_900x.jpg?v=1612792836); background-size: cover; background-position: center; background-repeat: no-repeat;">
                    </div>
                </a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
