    ...
    <div class="packages-list" style="height:66vh; overflow: auto;">
        <div class="form-row mt-1 mt-5 mb-5 section-frames">
            ...
            <div class="col-12 col-lg-6 mt-4">
                <a href="./?page=select-store-studios" class="select-link" id="studios">
                    <img class="img-fluid" src="/sis/studios/assets/images/sections/sun-frames.webp?v=1614047286">
                </a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
        ...
        <div class="form-row mb-5 section-antirad">
            ...
            <div class="col-12 col-lg-6 mt-4">
                <a href="./?page=select-antirad" class="select-link" id="studios">
                    <img class="img-fluid" src="/sis/studios/assets/images/sections/anti-rad-frames.webp?v=1614047286">
                </a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
        ...
        <div class="form-row mb-5 section-readers">
            <div class="col-12 text-center type-header">
                <h3>READERS</h3>
                <p></p>
                <a href="./?page=select-readers" class="select-link"><input type="button" class="btn btn-black" value="Shop All Readers"></a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
                <a href="./?page=select-readers" class="select-link" id="studios">
                    <img class="img-fluid" src="/sis/studios/assets/images/sections/readers.png?v=1614047286">
                </a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
        ...
        <div class="form-row mb-5 section-free-item">
            <div class="col-12 text-center type-header">
                <h3>FREE ITEM</h3>
                <p></p>
                <a href="./?page=select-free-item" class="select-link"><input type="button" class="btn btn-black" value="Shop All Free Item"></a>
            </div>
            <div class="col-12 col-lg-6 mt-4">
                <a href="./?page=select-free-item" class="select-link" id="free-item">
