...
if (!isset($_SESSION['customer_id'])) {
    ...
    <div class="packages-list hiding">
        ...
        <div class="frame-list ">
            ...
            <div class="row align-items-start " style="margin: 5px -10px; ">

                <?php for ($i = 0; $i < count($arrProductsSorted); $i++) { ?>

                    <div class="frame-style col-md-6 mb-3 " data-style="<?= $arrProductsSorted[$i]['item_description'] ?>">
                        <div class="frame-style__slider">
                            ...
                            for ($a = 0; $a < sizeOf($curColors); $a++) {
                                ...
                                <div class="product-option" prod-item-link="frame" data-color-name="<?= $curColors[$a]['color'] ?>"
                                    ...
                                    <label class="list-item frame-grid d-flex flex-column align-items-center justify-content-center"
                                        ...
                                        // $curImageURL = '/sis/studios/assets/images/sections/sun-frames.webp?v=1614047286';
                        ...
                        <div style="border-radius: 0 0 16px 16px !important; background-color: #fff; padding: 0 15px 15px 15px;">
                            <div class="d-flex justify-content-between">
                                <section
                                    class="product-details flex-nowrap no-gutters align-items-start justify-content-between">
                                    <h4><?= $arrProductsSorted[$i]['item_description'] ?> <br>
                                        <span class="blk"><?= trimColor($curColors[0]['color']); ?></span>
                                    </h4>
                                </section>
                                <section
                                    class="product-details flex-nowrap no-gutters align-items-start justify-content-between">
                            ...
                            <ul class="row switch-color p-0">
                                <?php if (sizeOf($curColors) > 4) { ?>
                                    <li class="more-item">+<?= sizeOf($curColors) - 4 ?></li>
                                <?php } ?>

                                <?php for ($a = 0; $a < sizeOf($curColors); $a++) { ?>
                                    <li class="<?= $a < 4 ? 'visible' : 'hidden' ?>" data-index="<?= $a ?>"
