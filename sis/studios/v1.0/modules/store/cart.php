                    ...
                    <div class="col-md-8 d-flex align-items-center">
                        <div class="card-body d-flex flex-column gap-3 pt-0 pb-0 pr-0">
                            ...
                            <div class="d-flex align-items-center justify-content-left">
                                ...
                                <input type="text" style="font-size: 16px;" class="form-control count_num bg-transparent" group-orders-specs-id="<?= $order['group_orders_specs_id'] ?>" value="<?= $order['count'] ?>" readonly>
