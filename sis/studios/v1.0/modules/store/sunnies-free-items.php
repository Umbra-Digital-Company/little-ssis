...
<?php
   ...
   include "./modules/includes/products/grab_free_item.php";
?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(this).on('click','.product-option',function(){
            ...
            window.location  ="?page=select-free-item&product-detail=true&product-code="+tempProduct.product_code+"&desc="+tempProduct.description+"&style="+tempProduct.item_description+"&color="+tempProduct.color+"&price="+tempProduct.price+"&image="+tempProduct.image_url+"&descr="+tempProduct.product_description+"&tags="+tempProduct.tags;
        });
        ...
        $(document).on('submit', "#form-add-to-bag", function(e){
            ...
            $.ajax({
                ...
                success: function(response){
                    window.location  ="?page=select-free-item";
                },
                error: function(){
                }
            });//END :: AJAX
       ...
       $(this).on('click', '.remove_item', function(){
        ...
        $('#search_frame').on('keyup', function () {
            ...
            setTimeout(()=>{
                window.location = '?page=select-free-item'+filter+'&search='+$(this).val(); 
             },3000);
        ...
        $('#filter-search-data').click(function(){
            ...
            window.location = '?page=select-free-item'+filter+'&colors='+arrColors+'&shapes='+arrShapes+'&collections='+arrCollections;  
        });
    });
