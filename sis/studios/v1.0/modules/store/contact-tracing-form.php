...
<?php if (isset($_GET['guest'])) { ?>
	...
	<div class="wrapper-guest customer-guest">
		...
		<form action="/sis/studios/func/process/guest_register.php?path_loc=v1.0" method="post" class="form-guest"
				...
				<div class="text-center mt-2">
					<div class="form-row">
						<div class="col-md-12 form-group">
							<input type="button" name="login-submit" id="btnsubmit" value="<?= $arrTranslate['Continue'] ?>"
