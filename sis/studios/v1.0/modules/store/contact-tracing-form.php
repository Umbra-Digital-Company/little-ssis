		...
		<form name="create_account" id="create_account" action="/sis/studios/func/process/store-register-v2.php" method="POST" autocomplete="off">
			...
			<div class="form-row no-gutters mt-3">
				...
				<div class="col-12 col-lg-16 col-md-6">
					...
					<input type="date" class="form-control sr-only" id="bdate2" value="<?= get_customer_data('birthday') ?>" >
					<?php
				...
				<div class="col-12 col-md-6">
					<div class="form-group gender">
						<input class="sr-only" type="radio" id="gender-male" value="Male" checked='checked' required style="display: none;">
						<select class="text-left s-a mh-40 select form-control" name="gender" id="gender" required>
							<option value="" disabled selected></option>
			...
			<div class="text-center mt-4">
				...
				<?php if ( !isset($_SESSION['customer_id']) ) : ?>
					...
					<?php if(isset($_SESSION['language_setting']) && $_SESSION['language_setting'] == 'vn') {?>
						<p class="text-secondary mb-3"><?= $arrTranslate['By clicking Submit, you have read and agreed to our Terms and Conditions'] ?>.</p>
					<?php }else{ ?>
				...
				<button type="submit" class="btn btn-black" id="submitCustomer"><?= isset($_SESSION['customer_id']) ? $arrTranslate['Proceed'] : $arrTranslate['Submit'] ?></button>
