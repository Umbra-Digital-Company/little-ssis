        ...
        <?php } else { ?>
            ...
            <section class="product-panel" id="product-panel">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <a href="/sis/studios/v1.0/?page=cart">Cart</a>
                ...
                <div class="flex-container mb-3">
                    ...
                    <button class="btn btn-bag " id="   " disabled>
        ...
        $(document).ready(function() {
            ...
            $("#cart").click(function() {
                ...
                for (let i = 0; i < arrCart.length; i++) {
                    if (parseFloat(arrCart[i].price) > 0) {} else if (arrCart[i].item_description.toLowerCase().indexOf('paper bag') > -1 || arrCart[i].item_description.toLowerCase().indexOf('sac') > -1 || arrCart[i].item_description.toLowerCase().indexOf('receipt') > -1) {
                        continue;
                    }
