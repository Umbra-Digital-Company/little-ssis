                        ...
                        ?>
                            <div class="card-body pt-3 pb-1 pl-1">
                               <div class="d-flex justify-content-between mb-4">
                                    <div class="col mt-3">
                                        <p style="font-size: 12px;"><?= $arrTranslate['How did you find out about us?'] ?></p>
                                    </div>
                                    ...
                                    <select name="findout" id="findout" class="form-control">
                                        <option value=""></option>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(this).on('change','#findout',function(){
            $('#loading').modal('show');
            $.post("/sis/studios/func/process/findout.php",{findout:$(this).val()}, function(result){
                setTimeout(()=>{
                    $('#loading').modal('hide');
                },200);
            });
        ...
        $(this).on('click','.club_member',function(){
            $('#loading').modal('show');
            $.post("/sis/studios/func/process/club_member.php",{club_member:$(this).val()}, function(result){
                setTimeout(()=>{
                    $('#loading').modal('hide');
                },200);
            });
