...
$querypn="";
 ...
 $querypn .="SELECT  p.first_name, p.last_name,os.product_code,os.prescription_id,os.order_id,u.first_name as uf,u.middle_name as um,u.last_name as ul,pr.color,p.profile_id,os.status,pr.item_description,os.lens_option,lab_name,
...
where o.store_id='".$_SESSION['store_code']."' ";
