...
$querypn .=' FROM 
            ...
            WHERE
                p.data_cgc IN("DCGC0006","DCGC0023","DCGC0043","DCGC0045","DCGC0046","DCGC0054","DCGC0056","DCGC0057","DCGC0064")
            ORDER BY 
                p.item_name ASC;';
...
$query .=       ' IF(
            ...
            WHERE ';
                ...
                elseif(isset($_SESSION['store_type']) && trim($_SESSION['store_type']) == 'sr'){
                    $query .= 'p.data_cgc IN("DCGC0006","DCGC0023","DCGC0043","DCGC0045","DCGC0046","DCGC0054","DCGC0056","DCGC0057","DCGC0064")';
                }else{
                    $query .= 'p.data_cgc IN("DCGC0006","DCGC0023","DCGC0043","DCGC0045","DCGC0046","DCGC0054","DCGC0056","DCGC0057","DCGC0064")';
                }
            ...
            ORDER BY 
                ...
                // OR p.product_code like "KLB00%"
                // OR p.product_code like  "MSEP%"
