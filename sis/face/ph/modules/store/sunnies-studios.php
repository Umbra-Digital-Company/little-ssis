    ...
    $(document).ready(function(){
                ...
                item_cart+='<div class="card cart_view mt-4">'
                    +'<div class="card-body">'
                        ...
                        +'<div class="d-flex justify-content-end">'
                            ...
                            +'<img src="/sis/studios/assets/images/icons/icon-delete.png" class="img-responsive remove_item" orders-specs-id="'+arrCart[i].group_orders_specs_id+'" style="cursor: pointer; margin-left: 10px;" width="25" height="25" title="Remove this item">'
                        +'</div>'
                    +'</div>'
                +'</div>';
            }
       ...
       $(this).on('click', '.remove_item', function(){
        ...
        $(this).on('click', '.count_increment', function(){
            ...
            $.post("/sis/studios/func/process/add_to_bag"+merch+".php",{studios_product_code: _this.attr('product-code')}, function(result){
                //console.log(result);
