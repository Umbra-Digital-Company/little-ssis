...
$querypn .=' FROM 
            ...
            WHERE
                 p.item_code NOT LIKE "%AC%"
                    ...
                    AND p.item_code NOT LIKE "%AR%"
                    AND p.item_code NOT LIKE "SM%"
                    AND p.item_code != "KLB00-01"
                    '.$priceWhere.'
            ORDER BY 
                p.item_name ASC;';
$grabFrames = array(
...
$query .=       ' IF(
            ...
            WHERE
                ...
                ORDER BY 
                    ...
                    // AND p.product_code NOT LIKE "SM%"
                    // AND p.product_code NOT LIKE "R0%"
                    // AND p.product_code NOT LIKE "MS%"
                    // AND p.product_code != "KLB00-01"
// echo $query; exit;
$grabParams = array(
    "description", 
    "color", 
