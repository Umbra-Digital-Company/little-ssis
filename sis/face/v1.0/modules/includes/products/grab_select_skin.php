...
$querypn .=' FROM 
                poll_51_face_new p
            WHERE p.data_cgc IN("DCGC0031","DCGC0030","DCGC0038","DCGC0026", "DCGC0075")
                    '.$priceWhere.'
            ORDER BY 
                p.item_name ASC;';
...
$arrColorData = [];
    $queryAll = 'SELECT DISTINCT
                    ...
                    WHERE 
                        p.data_cgc IN("DCGC0031","DCGC0030","DCGC0038","DCGC0026", "DCGC0075")
...
if(!isset($_GET['filter'])){
    ...
    $queryAll = "SELECT
                    ...
                    p51.item_code
                     ...
                     WHERE ss.category = 'skin' AND active = 1
