...
<?php if(isset($_GET['guest'])){ ?>
		...
		<div class="wrapper">
			<form action="/sis/face/func/process/guest_register.php?path_loc=v1.0" method="post">
...
<?php }else{ ?>
	...
	<div class="account-content active mt-4 mb-4" id="create-content">
		<form name="create_account" id="create_account" action="/sis/face/func/process/store-register-v2.php" method="POST" autocomplete="off">
