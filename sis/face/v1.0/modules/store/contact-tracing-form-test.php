...
<?php }else{ ?>
	...
	<div class="account-content active mt-4 mb-4" id="create-content">
		<form name="create_account" id="create_account" action="/sis/face/func/process/store-register-v3.php" method="POST" autocomplete="off">
...
<?php } ?>
<script src="/sis/face/assets/js/select2.min.js"></script>
<script>
