                        ...
                        <?php for($i = 0; $i < sizeOf($arrProductsSorted); $i++) { ?>                       
                            ...
                            <div class="frame-style col-6 mb-3" data-style="<?= $arrProductsSorted[$i]['item_description'] ?>">
                                ...
                                ?> 
                                    ...
                                    <div class="product-option" prod-item-link="eyes" data-color-name="<?= $curColors[$a]['color'] ?>" data-color-code="<?= $curColors[$a]['product_code'] ?>" product-code="<?= $curColors[$a]['product_code'] ?>">
                                ...
                                <div style="background: #f2efea; padding: 15px; border-radius: 0 0 10px 10px;">
                                    ...
                                    <div class="row d-flex justify-content-center mt-3">
                                        <form class="col-12 form-quick-add-to-bag" item="eyes" id="form-quick-add-to-bag<?= $i ?>" method="POST">
