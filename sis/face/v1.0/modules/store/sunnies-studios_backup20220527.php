                                ...
                                ?> 
                                    ...
                                    <div class="product-option" data-color-name="<?= $curColors[$a]['color'] ?>" data-color-code="<?= $curColors[$a]['product_code'] ?>" product-code="<?= $curColors[$a]['product_code'] ?>">
                                        ...
                                        ?>
                                            ...
                                            <p style="font-size: 12px; position: absolute; top: 10px; right: 10px;">₱<?= $arrProductsSorted[$i]['price'] ?></p>
                                ...
                                <div style="background: #e8e8e4; padding: 15px; border-radius: 0 0 10px 10px;">
                                    ...
                                    <ul class="row switch-color p-0" style="margin: 0 -3px;">
                                        ...
                                        <?php for($a = 0; $a< sizeOf($curColors); $a++) { ?>
                                            ...
                                            <li class="<?= $a === 0 ? 'active' : '' ?>" data-index="<?= $a ?>" data-style-name="<?= $arrProductsSorted[$i]['item_description'] ?>" data-color-name="<?= trimColor($curColors[$a]['color']) ?>" data-color-code="<?= $curColors[$a]['product_code'] ?>" style="<?=($curColors[$a]['color_picker'] != '') ? $curColors[$a]['color_picker'] : 'background-color: #000;' ?>"></li>
                                    ...
                                    <div class="row d-flex justify-content-center mt-3">
                                        <form class="col-12 form-quick-add-to-bag" id="form-quick-add-to-bag<?= $i ?>" method="POST">
                                            <input type="hidden" name="studios_product_code" id="input-sku-<?= $arrProductsSorted[$i]['item_description'] ?>" value="<?= $curColors[0]['product_code'] ?>">
