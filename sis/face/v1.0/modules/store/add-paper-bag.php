                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div style="text-align:left">
                                ...
                                <img src="././images/face/front.png" class="img-responsive" width="160" height="50" >
                                <hr class="spacing">
                                        ...
                                        ?> 
                                            <div class="col-lg-4 col-xs-12 form-group product-option" product-code="<?= $arrProduct[$i]['product_code'] ?>">
                                                ...
                                                <label class="list-item frame-grid d-flex flex-column align-items-center justify-content-center">
                                                    <img src="././images/face/front.png" class="img-fluid" >
...
<script>
    ...
    $(document).ready(function(){
       ...
       $(this).on('click', '.remove_item', function(){
           let this_div = $(this);
             let remove = $.post("modules/process/remove_item.php",{orders_specs_id: this_div.attr('orders-specs-id')}, function(){
            });
        ...
        $(this).on('click', '.count_increment', function(){
            _this = $(this);
            arrOrdersSpescId = $(this).attr('group-orders-specs-id').split(",");
            $.post("modules/process/add_to_bag.php",{studios_product_code: _this.attr('product-code')}, function(result){
                //console.log(result);
