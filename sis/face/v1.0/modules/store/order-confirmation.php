    ...
    <section class="col-lg-12 col-md-12 col-xs-12 hidden-xs product-panel" id="product-panel">
        ...
        <?php
            ...
            for($i = 0; $i< count($arrCart); $i++) {
                ...
                // $curImageURL = "././images/face/front.png";
                ...
                // }
                //  $curImageURL = (@getimagesize($curImageURL)) ?  $curImageURL : '/sis/face/assets/images/defaults/no_specs_frame_available_b.png';
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-6">
                            <div class="justify-content-center">
                                 <div class="image-wrapper" style="height: 30vh; width: 50%; background-image: url(<?= $curImageURL ?>); background-repeat: no-repeat; background-size: 80%; background-position: center;"></div>                            
        ...
        <?php } ?>
            ...
            <div class="d-flex justify-content-center mt-5">
                <div>
                   <p style="font-size:18px; font-weight: bold;" id='btn-paperbag' data-toggle="collapse" data-target="#paperbag-set-list">Packaging</p>
                </div>
            </div>
                ...
                <div id="paperbag-set-list" class="pl-2 pr-2 pt-1" style="">
                    <div class="card mt-2 card-paper-bag" style="background-color: #E8E8E4 !important">
                        ...
                        ?>
                         ...
                         <div>
                            <input type="button" value="Add Additional Paper Bag" id="add_section_paper_bag" class="btn btn-primary">
                        </div>
                    </div>
                    ...
                    <!-- <div class="card mt-3 card-sac" style="background-color: #E8E8E4 !important">
                        ...
                        ?>
                         ...
                         <div>
                            <input type="button" value="Add Additional Sac" id="add_section_sac" class="btn btn-primary">
                        </div>
                    </div> -->
                    ...
                    <div class="card mt-3 card-others" style="background-color: #E8E8E4 !important">
                        ...
                        ?>
                            <div class="card-body pt-3 pb-1 pl-1">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="col mr-4">
                                        <p style="font-size: 12px;">Does this order include a Receipt Holder?</p>
                                    </div>
            ...
            <div class="row d-flex justify-content-center mt-5" >
                <div class="col-12">
                    <p class="mb-2" style="font-size:17px; font-weight: bold; text-align: center;">Would you like to login or sign up?</p>
                </div>
                <div class="col-6 mt-1">
                    <input type="button" class="btn" style="background-color: #bad2d8; color: #fff;" id="btn-login" value="Login">
                </div>
                <div class="col-6 mt-1">
            ...
            <div class="row d-flex justify-content-center mt-5" >
                ...
                <div class="col-12">
                    <?php if(!isset($_SESSION['guest_customer'])){ ?>
                        ...
                        <a href="/sis/face/func/process/order_payment.php?path_loc=v1.0" id="send-order"><input type="button" class="btn btn-black" value="<?= $textSend ?>"></a>
                    <?php }else{ ?>
                        <input type="button" class="btn btn-black" id="btn-guest-register" value="Proceed">
                    <?php } ?>
                </div>
            </div>            
        </form>
...
<script>
    ...
    $(document).ready(function(){
        $(this).on('click', '.add_count_increment_pbag', function(){
            ...
            if(count_num_val >= total_count){
                if(confirm('Your about to exceed the total count of frames.')){
                    ...
                    $.post("/sis/face/func/process/add_to_bag_merch.php",{studios_product_code: productSelected, paper_bag:true}, function(result){
                        //console.log(result);
        ...
        $(this).on('click','#add_section_paper_bag',function(){
            $.get('/sis/face/v1.0/modules/includes/products/add_paper_bag_section.php', function(result){
        ...
        $(this).on('click','#add_section_sac',function(){
            $.get('/sis/face/v1.0/modules/includes/products/add_sac_section.php', function(result){
        ...
        $(this).on('click','.set_receipt_holder',function(){
            ...
            if($(this).val() == 'yes'){
                if($(this).attr('orders-specs-id') == ''){
                    $('#loading').modal('show');
                    $.post("/sis/face/func/process/add_to_bag_merch.php",{studios_product_code: $(this).attr('product-code'), paper_bag:true}, function(result){
                ...
                if($(this).attr('orders-specs-id') != ''){
                    $('#loading').modal('show');
                     $.post("/sis/face/func/process/remove_item.php",{orders_specs_id: $(this).attr('orders-specs-id')}, function(){
        ...
        $(this).on('click','#add_section_others',function(){
            $.get('/sis/face/v1.0/modules/includes/products/add_others_section.php', function(result){
        ...
        $('#btn-login').click(function(){
         ...
         $('#update_guest_account').submit(function(e){
            e.preventDefault();
            $.ajax({
                url: "/sis/face/func/process/signup-guest-accountv2.php",
                type: "post",
                data: $(this).serialize() ,
        ...
        $('#btn-guest-register').click(function(){
            $('#modal-guest-register').modal('show');
        });
    });
</script>
