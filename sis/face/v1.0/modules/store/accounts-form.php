...
<?php } else { ?>
		...
		<div class="account-login">
			<form method="post" id="use_account" name="use_account" autocomplete="off" class="form-login" >
				...
				<div class="text-center ">
					<div class="form-row">
						<div class="col-md-12 form-group">
							<a href="/sis/face/v1.0/?page=account-form&guest=true&bpage=<?= $_GET['bpage'] ?>">
    ...
    if (e.keyCode == 13) {
		...
		$.post("/sis/face/v1.0/modules/store/store-sign-master.php?bpage=<?= $_GET['bpage'] ?>",$("form#use_account").serialize(),function(d){
	...
	<div class="account-content  mt-4 mb-4" id="create-content">
		<form name="create_account" id="create_account" action="/sis/face/func/process/store-register-v2.php?bpage=<?= $_GET['bpage'] ?>"
