	  ...
	  <div class="card-body">	  	
	  	<div class="d-flex justify-content-center">
	  		<?php if(isset($_SESSION['dispatch_studios_no_access']) && !$_SESSION['dispatch_studios_no_access']) { ?>
		  		<a href="/face/dispatch-face" style="color: #fff; margin-right: 30px;"><button type="button" class="btn btn-black">Go to Dispatch</button></a>
		  	<?php } ?>	
		  	<a href="/sis/face/v1.0/?page=store-home" style="color: #fff"><button type="button" class="btn btn-primary">Go to Home Page</button></a>
		  </div>
	  </div>
	</div>
</div>