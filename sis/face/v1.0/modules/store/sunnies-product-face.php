...
<?php
    ...
    switch($_GET['page']){
            ...
            case "select-store-lips":  include "./modules/includes/products/grab_sun_frames.php"; break;
            case "select-store-face":  include "./modules/includes/products/grab_face.php"; break;
            case "select-store-brows":  include "./modules/includes/products/grab_brows.php"; break;
            case "select-store-eyes":  include "./modules/includes/products/grab_eyes.php"; break;
            case "select-store-skin":  include "./modules/includes/products/grab_skin.php"; break;
            case "select-store-cheeks":  include "./modules/includes/products/grab_cheeks.php"; break;
    }
