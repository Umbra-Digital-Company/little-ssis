...
if (mysqli_stmt_prepare($stmt, $query)) {
	...
	mysqli_stmt_bind_param($stmt, 'sssss', $profileIDF, $pi_emailAddress, $_SESSION["store_code"], now(), $_SESSION['id']);
	mysqli_stmt_execute($stmt);		
...
if (mysqli_stmt_prepare($stmt2, $query2)) {
	...
	mysqli_stmt_bind_param($stmt2, 'sss', $profileIDF, $pi_emailAddress, $password);
