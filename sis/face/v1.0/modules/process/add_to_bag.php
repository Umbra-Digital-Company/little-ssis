...
function insertItem(){
    ...
    mysqli_stmt_bind_param($stmt, 'sssssss', $finalOrderId, $_SESSION["customer_id"], $_POST['studios_product_code'], $total, now(), $orderSpecsIdPoNumber['po_number'], $orderSpecsIdPoNumber['order_specs_id']);
    mysqli_stmt_execute($stmt);		
