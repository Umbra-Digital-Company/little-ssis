	...
	if ( isset($_POST['email_confirmation']) ) { // UPDATE DATA
		...
		if ($pi_email=='n') {
			...
			if (mysqli_stmt_prepare($stmt, $query)) {
				...
				mysqli_stmt_bind_param($stmt, 'ssssssssssssssssss', $profileIDF, $_POST['lname'], $_POST['fname'], $_POST['mname'], $_POST['country'], $pi_province, $pi_city, $pi_barangay, $_POST['bdate'], $_POST['age'], $_POST['gender'], $_POST['email'], $_POST['mnum'], $_SESSION["store_code"], now(), $_SESSION["id"], $_POST['home_address'], $priority);
				mysqli_stmt_execute($stmt);
			}
			...
			if (mysqli_stmt_prepare($stmt2, $query2)) {
				...
				mysqli_stmt_bind_param($stmt, 'sss', $profileIDF, $_POST['email'], $password);
				mysqli_stmt_execute($stmt2);
			}
